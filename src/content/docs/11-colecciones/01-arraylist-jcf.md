...
> 🗺️ **Estás en:** 📚 **U11 · Colecciones** → 01 · ArrayList y el Java Collections Framework
...
En la U05 viste los arrays: tamaño fijo, acceso por índice y mucho trabajo manual. Llegó el momento que estaban esperando: el parking se ha quedado pequeño y necesitas algo que crezca. Aquí empieza la unidad de las colecciones y, probablemente, la herramienta que más usarás en tu vida como programadora o programador.
...
> 📝 **Nota:** lo mismo con el resto de primitivos: `boolean` → `Boolean`, `double` → `Double`, `char` → `Character`... Si necesitas saber más sobre genéricos y wrappers, los puntos 4 y 5 de esta misma unidad los estiran a fondo.
...
📚 [Volver al índice de la unidad](/ApuntesProgramacion/11-colecciones) · **Anterior:** — · **Siguiente:** [02 · LinkedList: la conga line](/ApuntesProgramacion/11-colecciones/02-linkedlist)