...
> 📝 **Nota:** lo mismo con el resto de primitivos: `boolean` → `Boolean`, `double` → `Double`, `char` → `Character`... Si necesitas saber más sobre genéricos y wrappers, la U12 los estira a fondo.
