...
> 🗺️ **Estás en:** 📚 **U11 · Colecciones** → 06 · La clase Collections: la navaja suiza
...
En el punto 5 viste cómo recorrer colecciones sin morir en el intento. Ahora toca manipularlas sin escribir un solo bucle a mano. Igual que `Arrays` era la navaja suiza de los arrays (lo viste en la U05), `Collections` lo es de las colecciones. Métodos estáticos (de la U09) que hacen en una línea lo que tú tardarías en 10.
...
3. Es la hermana de la clase `Arrays` (vista en la U05), pero aplicada a colecciones: misma idea, otros parámetros.
...
📚 [Volver al índice de la unidad](/ApuntesProgramacion/11-colecciones) · **Anterior:** [05 · Iterator: el camarero que toma nota](/ApuntesProgramacion/11-colecciones/05-iterator) · **Siguiente:** [07 · Elegir la colección adecuada](/ApuntesProgramacion/11-colecciones/07-elegir-coleccion)