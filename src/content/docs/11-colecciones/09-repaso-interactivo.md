...
> 🗺️ **Estás en:** 📚 **U11 · Colecciones** → 09 · Repaso interactivo
...
**PROXIMAMENTE EN U12:** Genéricos y Mapas. El momento en el que tus colecciones aprenden a hablar de sí mismas con `<T>` y a guardar parejas de clave-valor. 🗺️

---

📚 [Volver al índice de la unidad](/ApuntesProgramacion/11-colecciones) · **Anterior:** [08 · Be the Code: colecciones en acción](/ApuntesProgramacion/11-colecciones/08-be-the-code) · **Siguiente:** **[U12 · Genéricos y Mapas](/ApuntesProgramacion/12-genericos-mapas)**