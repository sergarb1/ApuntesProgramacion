...
> 🗺️ **Estás en:** 📚 **U11 · Colecciones** → 07 · Elegir la colección adecuada
...
**La regla de oro:** ¿sabes cuántos elementos necesitas y no va a cambiar? → array (U05). ¿Lista que crece y acceso por índice? → ArrayList. ¿Cola o pilas? → LinkedList. ¿Sin duplicados y no te importa el orden? → HashSet. ¿Sin duplicados y ordenados? → TreeSet. ¿Sin duplicados pero manteniendo el orden de llegada? → LinkedHashSet.
...
📚 [Volver al índice de la unidad](/ApuntesProgramacion/11-colecciones) · **Anterior:** [06 · La clase Collections: la navaja suiza](/ApuntesProgramacion/11-colecciones/06-collections) · **Siguiente:** [08 · Be the Code: colecciones en acción](/ApuntesProgramacion/11-colecciones/08-be-the-code)