...
> 🗺️ **Estás en:** 🌐 **U15 · Servir y Consumir APIs con Web** → 06 · Mini proyecto: gestor de tareas (API REST)
...
> 💡 **Consejo:** `AtomicInteger` te da IDs que no se repiten ni con peticiones simultáneas. Con un `int` normal, dos peticiones a la vez podrían leer el mismo valor. En producción, ese `ArrayList` sería una base de datos (JDBC, como en la U14), pero el patrón es idéntico.
...
📚 [Volver al índice de la unidad](/ApuntesProgramacion/15-apis-web) · **Anterior:** [05 · Devolviendo JSON: como una API de verdad](/ApuntesProgramacion/15-apis-web/05-devolviendo-json) · **Siguiente:** [07 · Consumir APIs externas con HttpClient](/ApuntesProgramacion/15-apis-web/07-httpclient)