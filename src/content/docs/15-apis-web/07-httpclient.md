...
> 🗺️ **Estás en:** 🌐 **U15 · Servir y Consumir APIs con Web** → 07 · Consumir APIs externas con HttpClient
...
📚 [Volver al índice de la unidad](/ApuntesProgramacion/15-apis-web) · **Anterior:** [06 · Mini proyecto: gestor de tareas (API REST)](/ApuntesProgramacion/15-apis-web/06-proyecto-rest) · **Siguiente:** [08 · HttpClient avanzado](/ApuntesProgramacion/15-apis-web/08-httpclient-avanzado)