...
> 🗺️ **Estás en:** 🌐 **U15 · Servir y Consumir APIs con Web** → 05 · Devolviendo JSON: como una API de verdad
...
📚 [Volver al índice de la unidad](/ApuntesProgramacion/15-apis-web) · **Anterior:** [04 · Parámetros GET y formularios POST](/ApuntesProgramacion/15-apis-web/04-get-post) · **Siguiente:** [06 · Mini proyecto: gestor de tareas (API REST)](/ApuntesProgramacion/15-apis-web/06-proyecto-rest)