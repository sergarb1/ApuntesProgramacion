...
> 🗺️ **Estás en:** 🌐 **U15 · Servir y Consumir APIs con Web** → 03 · Sirviendo HTML
...
📚 [Volver al índice de la unidad](/ApuntesProgramacion/15-apis-web) · **Anterior:** [02 · Servidor web mínimo con HttpServer](/ApuntesProgramacion/15-apis-web/02-servidor-minimo) · **Siguiente:** [04 · Parámetros GET y formularios POST](/ApuntesProgramacion/15-apis-web/04-get-post)