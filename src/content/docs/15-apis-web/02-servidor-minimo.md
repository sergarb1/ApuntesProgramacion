...
> 🗺️ **Estás en:** 🌐 **U15 · Servir y Consumir APIs con Web** → 02 · Servidor web mínimo con HttpServer
...
📚 [Volver al índice de la unidad](/ApuntesProgramacion/15-apis-web) · **Anterior:** [01 · El protocolo HTTP en 30 segundos](/ApuntesProgramacion/15-apis-web/01-protocolo-http) · **Siguiente:** [03 · Sirviendo HTML](/ApuntesProgramacion/15-apis-web/03-sirviendo-html)