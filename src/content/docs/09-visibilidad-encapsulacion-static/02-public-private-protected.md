...
Es como las historias vergonzosas de la familia. Tus primos (mismo paquete) y tus hijos (subclases) pueden acceder. Pero un desconocido de otro paquete... no. En la U10 (herencia) lo exprimirás de verdad; por ahora, quédate con la idea: *protegido para la familia*.
...
📚 [Volver al índice de la unidad](/ApuntesProgramacion/09-visibilidad-encapsulacion-static) · **Anterior:** [01 · Visibilidad: el arte de no enseñarlo todo](/ApuntesProgramacion/09-visibilidad-encapsulacion-static/01-visibilidad) · **Siguiente:** [03 · Encapsulación: el pilar de la POO](/ApuntesProgramacion/09-visibilidad-encapsulacion-static/03-encapsulacion)