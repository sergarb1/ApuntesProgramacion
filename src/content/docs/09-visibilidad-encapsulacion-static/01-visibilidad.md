...
En la U08 construiste clases con atributos y métodos. Pero hay una pregunta que no te hiciste: *¿y si alguien le pone `edad = -666` a mi objeto Persona?* Si todo es público, cualquiera puede hacerlo desde cualquier sitio. Y ahí es donde empieza esta unidad: en el momento en el que tu código necesita **puertas**.
...
Aquí tienes una clase de la U08 escrita "a lo bruto", con todo público:
...
📚 [Volver al índice de la unidad](/ApuntesProgramacion/09-visibilidad-encapsulacion-static) · **Anterior:** [Índice de la unidad](/ApuntesProgramacion/09-visibilidad-encapsulacion-static) · **Siguiente:** [02 · public, private y protected](/ApuntesProgramacion/09-visibilidad-encapsulacion-static/02-public-private-protected)
