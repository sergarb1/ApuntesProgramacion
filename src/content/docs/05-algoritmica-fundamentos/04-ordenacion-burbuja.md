...
> 🗺️ **Estás en:** 🧩 **U05 · Algorítmica I: Fundamentos** → 04 · Ordenación burbuja
...
> 💡 **Consejo:** burbuja solo se usa en dos situaciones: (1) estás aprendiendo, y (2) sabes que el array tendrá menos de 50 elementos. Para todo lo demás hay mejores alternativas (las verás en la U06).
...
4. Solo para aprender, o con arrays de **menos de ~50 elementos**. Para el resto, espera a la U06.
...
📚 [Volver al índice de la unidad](/ApuntesProgramacion/05-algoritmica-fundamentos) · **Anterior:** [03 · Búsqueda binaria](/ApuntesProgramacion/05-algoritmica-fundamentos/03-busqueda-binaria) · **Siguiente:** [05 · Ordenación por inserción](/ApuntesProgramacion/05-algoritmica-fundamentos/05-ordenacion-insercion)
