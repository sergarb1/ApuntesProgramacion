...
> 🗺️ **Estás en:** 🧩 **U05 · Algorítmica I: Fundamentos** → 06 · Complejidad algorítmica: Big O
...
| O(n log n) | Casi lineal | Ordenaciones avanzadas (lo verás en la U06) | ~10.000 operaciones |
...
📚 [Volver al índice de la unidad](/ApuntesProgramacion/05-algoritmica-fundamentos) · **Anterior:** [05 · Ordenación por inserción](/ApuntesProgramacion/05-algoritmica-fundamentos/05-ordenacion-insercion) · **Siguiente:** [07 · Elegir el algoritmo adecuado](/ApuntesProgramacion/05-algoritmica-fundamentos/07-elegir-algoritmo)
