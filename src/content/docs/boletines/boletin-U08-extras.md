...
**Pista:** convierte a minúsculas y cuenta frecuencias con un `Map<Character, Integer>`; al final, cuenta cuántas entradas tienen frecuencia mayor que 1. (El `Map` se estudia a fondo en la U10, pero puedes usarlo ya.)
