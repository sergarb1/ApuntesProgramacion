...
**Pista:** para ordenar los dígitos, extráelos en un `int[]` de 4 posiciones con `% 10` y `/ 10`, ordénalo con bombolla (¡reutiliza la U06!), y reconstruye el número mayor (dígitos en orden descendente) y el menor (ascendente). Cuenta las iteraciones con un contador.
