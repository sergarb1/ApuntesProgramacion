...
> 🗺️ **Estás en:** 🎯 **U12 · Programación funcional (Streams y Lambdas)** → 01 · Lambdas: funciones que viajan solas
...
En la U11 viste las colecciones, los genéricos y los mapas. Todo genial. Pero para recorrerlas siempre había una constante: los bucles y los métodos uno tras otro. Hoy cambia la jugada: las funciones dejan de estar encadenadas a una clase y empiezan a **viajar solas**.
