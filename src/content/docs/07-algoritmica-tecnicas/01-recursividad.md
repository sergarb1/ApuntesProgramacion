...
En la U06 viste que un algoritmo se puede escribir con bucles. Pero hay problemas que se *expresan* de forma mucho más natural diciendo "este problema es como el mismo problema, pero más pequeño". Para esos casos nació la recursividad: la técnica estrella de esta unidad.
...
📚 [Volver al índice de la unidad](/ApuntesProgramacion/07-algoritmica-tecnicas) · **Anterior:** [Índice de la unidad](/ApuntesProgramacion/07-algoritmica-tecnicas) · **Siguiente:** [02 · Recursividad: ejemplos clásicos](/ApuntesProgramacion/07-algoritmica-tecnicas/02-recursividad-ejemplos-clasicos)
