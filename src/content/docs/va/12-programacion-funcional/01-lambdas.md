...
> 🗺️ **Estàs en:** 🎯 **U12 · Programació funcional (Streams i Lambdas)** → 01 · Lambdes: funcions que viatgen soles
...
En la U11 vas vore les col·leccions, els genèrics i els mapes. Tot genial. Però per a recórrer-les sempre hi havia una constant: els bucles i els mètodes un darrere l'altre. Hui canvia la jugada: les funcions deixen d'estar encadenades a una classe i comencen a **viatjar soles**.
