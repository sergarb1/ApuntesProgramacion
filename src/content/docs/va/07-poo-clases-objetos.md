---
title: "U07 — POO: Classes i Objectes"
...
> 🗺️ **El mapa del paquet:** 🚪 Benvinguda → ☕ U01 → 🔤 U02 → 🔀 U03 → 🅿️ U04 → 🧩 U05 → ⚡ U06 → **🏗️ ACÍ ETS (U07)** → 🔒 U08 → 🧬 U09 → 📚 U10 → 🗺️ U11 → 📁 U12 → 🗄️ U13 → 🌐 U14
...
|---|---|---|
| [01 · Què és la POO](/ApuntesProgramacion/va/07-poo-clases-objetos/01-que-es-poo) | Programació procedural vs orientada a objectes i per què el món real mana | Tots |
| [02 · Classes i objectes: el tallagalletas i les galetes](/ApuntesProgramacion/va/07-poo-clases-objetos/02-clases-objetos) | El motle, la galeta, `new`, i la teua primera classe | Tots |
| [03 · Atributs i mètodes](/ApuntesProgramacion/va/07-poo-clases-objetos/03-atributos-metodos) | Les propietats i els comportaments d'una classe, amb els seus tipus i paràmetres | Tots |
| [04 · Constructors](/ApuntesProgramacion/va/07-poo-clases-objetos/04-constructores) | El mètode que prepara l'objecte en nàixer: per defecte i amb paràmetres | Tots |
| [05 · La paraula clau this](/ApuntesProgramacion/va/07-poo-clases-objetos/05-this) | Quan els paràmetres es diuen igual que els atributs (i com eixir de l'embolic) | Tots |
| [06 · Referències, null i memòria](/ApuntesProgramacion/va/07-poo-clases-objetos/06-referencias-memoria) | Què guarda una variable d'objecte, el `heap`, `null` i el mític `NullPointerException` | Tots |
| [07 · Sobrecàrrega i pas per valor](/ApuntesProgramacion/va/07-poo-clases-objetos/07-sobrecarga-paso-valor) | Diversos mètodes amb el mateix nom i què es copia quan crides | Tots |
| [08 · Be the Code: dissenya la teua classe](/ApuntesProgramacion/va/07-poo-clases-objetos/08-be-the-code) | Dissenyar i construir una classe completa pas a pas, sense mirar | ⭐⭐⭐ |
| [09 · Repàs interactiu](/ApuntesProgramacion/va/07-poo-clases-objetos/09-repaso-interactivo) | Sé el Código, Fireside, Laboratori, Crucigrama i més | Tots |
...
> 📌 El punt 6 (referències i memòria) i el 7 (pas per valor) són la base per a entendre el **RA2 c) i f)** en profunditat. Els modificadors de visibilitat (RA4 f), l'herència (RA4 g) i els mètodes estàtics (RA4 h) tenen el seu propi capítol en la **U08** (Visibilitat i Static) i en la **U09** (Herència), així que ací els deixem descansant.

---

## 🚪 Per on comence?

- Cero coneixements de POO? → Arranca en el [punt 1](/ApuntesProgramacion/va/07-poo-clases-objetos/01-que-es-poo). Només necessites el que vas vore fins a la U06.
- Ja saps què és una classe i vols cim? → Ves directe al [punt 4](/ApuntesProgramacion/va/07-poo-clases-objetos/04-constructores) i al [punt 5](/ApuntesProgramacion/va/07-poo-clases-objetos/05-this): ací comença el ball seriós.
- Et flipen els reptes? → Fes el [punt 8](/ApuntesProgramacion/va/07-poo-clases-objetos/08-be-the-code) sense mirar el codi dels punts anteriors. Dissenya la teua classe amb honor.
- Vens a repassar? → Fes el [Repàs interactiu](/ApuntesProgramacion/va/07-poo-clases-objetos/09-repaso-interactivo) i després els [butlletins](/ApuntesProgramacion/va/boletines/boletin-u07-inicial).

**📍 Primer punt:** [01 · Què és la POO](/ApuntesProgramacion/va/07-poo-clases-objetos/01-que-es-poo)  
**⏭️ En acabar la unitat, continua en [U08 · Visibilitat, Encapsulació i Static](/ApuntesProgramacion/va/08-visibilidad-encapsulacion-static).**