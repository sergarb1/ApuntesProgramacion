...
Cada atribut té un tipus (que ja domines de la U03) i descriu una propietat de l'objecte. Quan crees un cotxe amb `new Coche()`, eixe cotxe concret tindrà **la seua pròpia còpia** dels quatre atributs. Un altre cotxe, altres còpies. Cada galeta porta les seues pepitas.

> 💡 **Tip:** els atributs es declaren amb els mateixos tipus que les variables: `String`, `int`, `double`, `boolean`... Si domines la U03, domines la mitat d'este punt.
...
📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/08-poo-clases-objetos) · **Anterior:** [02 · Classes i objectes: el tallagalletas i les galetes](/ApuntesProgramacion/va/08-poo-clases-objetos/02-clases-objetos) · **Següent:** [04 · Constructors](/ApuntesProgramacion/va/08-poo-clases-objetos/04-constructores)