...
2. **Encapsulació (U09):** cada objecte protegix les seues dades i decideix qui pot tocar-les. Com un compte bancari: el saldo no està tirat al carrer.
3. **Herència (U10):** una classe pot "heretar" d'una altra. Un `Perro` és un `Animal` i, a més, lladra.
4. **Polimorfisme (U10):** el mateix missatge, distintes respostes. Tots els animals "fan so"; el gos lladra i el gat miola.

> ⚠️ **Advertència:** no t'estresses amb els pilars 2, 3 i 4. Esta unitat et dona els fonaments; els altres els alcem en la U09 i la U10. Ací mana l'abstracció i el naixement de les classes.
...
> **Q:** Què passa amb el `main` que porte escrivint des de la U02? Ara no serveix?
>
...
4. L'**encapsulació** en la U09 i l'**herència** (i el polimorfisme) en la U10.
...
📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/08-poo-clases-objetos) · **Anterior:** [Índex de la unitat](/ApuntesProgramacion/va/08-poo-clases-objetos) · **Següent:** [02 · Classes i objectes: el tallagalletas i les galetes](/ApuntesProgramacion/va/08-poo-clases-objetos/02-clases-objetos)