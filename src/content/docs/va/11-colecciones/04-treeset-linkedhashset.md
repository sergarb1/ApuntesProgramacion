...
> 🗺️ **Estàs en:** 📚 **U11 · Col·leccions** → 04 · TreeSet i LinkedHashSet: l'ordenat i el que recorda
...
📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/11-colecciones) · **Anterior:** [03 · HashSet: el porter sense duplicats](/ApuntesProgramacion/va/11-colecciones/03-hashset) · **Següent:** [05 · Iterator: el cambrer que pren nota](/ApuntesProgramacion/va/11-colecciones/05-iterator)