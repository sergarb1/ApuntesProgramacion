...
> 🗺️ **Estàs en:** 📚 **U11 · Col·leccions** → 05 · Iterator: el cambrer que pren nota
...
📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/11-colecciones) · **Anterior:** [04 · TreeSet i LinkedHashSet: l'ordenat i el que recorda](/ApuntesProgramacion/va/11-colecciones/04-treeset-linkedhashset) · **Següent:** [06 · La classe Collections: la navalla suïssa](/ApuntesProgramacion/va/11-colecciones/06-collections)