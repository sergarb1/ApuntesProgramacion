...
> 🗺️ **Estàs en:** 📚 **U11 · Col·leccions** → 09 · Repàs interactiu
...
**PROXIMAMENT EN U12:** Genèrics i Mapes. El moment en què les teues col·leccions aprenen a parlar de si mateixes amb `<T>` i a guardar parelles de clau-valor. 🗺️

---

📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/11-colecciones) · **Anterior:** [08 · Be the Code: col·leccions en acció](/ApuntesProgramacion/va/11-colecciones/08-be-the-code) · **Següent:** **[U12 · Genèrics i Mapes](/ApuntesProgramacion/va/12-genericos-mapas)**