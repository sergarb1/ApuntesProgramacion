...
> 🗺️ **Estàs en:** 📚 **U11 · Col·leccions** → 06 · La classe Collections: la navalla suïssa
...
Al punt 5 vas vore com recórrer col·leccions sense morir en l'intent. Ara toca manipular-les sense escriure un sol bucle a mà. Igual que `Arrays` era la navalla suïssa dels arrays (ho vas vore en la U05), `Collections` ho és de les col·leccions. Mètodes estàtics (de la U09) que fan en una línia el que tu tardaries en 10.
...
3. És la germana de la classe `Arrays` (vista en la U05), però aplicada a col·leccions: mateixa idea, altres paràmetres.
...
📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/11-colecciones) · **Anterior:** [05 · Iterator: el cambrer que pren nota](/ApuntesProgramacion/va/11-colecciones/05-iterator) · **Següent:** [07 · Triar la col·lecció adequada](/ApuntesProgramacion/va/11-colecciones/07-elegir-coleccion)