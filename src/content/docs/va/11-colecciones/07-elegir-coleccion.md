...
> 🗺️ **Estàs en:** 📚 **U11 · Col·leccions** → 07 · Triar la col·lecció adequada
...
**La regla d'or:** saps quants elements necessites i no canviarà? → array (U05). Llista que creix i accés per índex? → ArrayList. Cua o pila? → LinkedList. Sense duplicats i no t'importa l'ordre? → HashSet. Sense duplicats i ordenats? → TreeSet. Sense duplicats però mantenint l'ordre d'arribada? → LinkedHashSet.
...
📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/11-colecciones) · **Anterior:** [06 · La classe Collections: la navalla suïssa](/ApuntesProgramacion/va/11-colecciones/06-collections) · **Següent:** [08 · Be the Code: col·leccions en acció](/ApuntesProgramacion/va/11-colecciones/08-be-the-code)