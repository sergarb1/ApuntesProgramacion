...
> 🗺️ **Estàs en:** 🅿️ **U05 · Arrays** → 04 · La classe Arrays: la teua navalla suïssa
...
Recorda: com són mètodes `static` (ho vas vore en la U08), es criden amb el nom de la classe: `Arrays.xxx(array)`. No cal crear cap objecte `Arrays` — de fet, no pots.
...
📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/05-arrays) · **Anterior:** [03 · Arrays multidimensionals](/ApuntesProgramacion/va/05-arrays/03-arrays-multidimensionales) · **Següent:** [05 · Arrays i mètodes](/ApuntesProgramacion/va/05-arrays/05-arrays-metodos)