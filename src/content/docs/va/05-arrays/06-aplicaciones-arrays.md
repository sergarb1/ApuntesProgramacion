...
> 🗺️ **Estàs en:** 🅿️ **U05 · Arrays** → 06 · Aplicacions dels arrays
...
> 💡 **Consell:** si necessites "canviar una lletra", amb `String` no pots. Una opció és passar-la a `char[]`, modificar-la i tornar a construir la `String`. En la U123 (fitxers i regex) esta idea eixirà diverses voltes.

---

## 🧍 Arrays d'objectes: l'aparcament de persones

Ací és on l'aparcament brilla de veritat. Els arrays no només guarden primitius o `String`: guarden **objectes** de qualsevol classe. Com encara no has creat les teues pròpies classes (això és la U07), usa una senzilla per a l'exemple:
...
📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/05-arrays) · **Anterior:** [05 · Arrays i mètodes](/ApuntesProgramacion/va/05-arrays/05-arrays-metodos) · **Següent:** [07 · Be the Code: l'aparcament es gestiona](/ApuntesProgramacion/va/05-arrays/07-be-the-code)