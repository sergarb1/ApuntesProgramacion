...
> 🗺️ **Estàs en:** 🅿️ **U05 · Arrays** → 07 · Be the Code: l'aparcament es gestiona
...
> 🕶️ **Don Tip:** pregunta sempre: quin tipus de dada guarda este array? Un `int` no pot valer `null`; un `Integer` sí (però això és un objecte de la U11).
...
Si volgueres "buidar" un `int[]`, hauríes de posar un valor de sentinella, per exemple `0` o `-1`. I si de veritat necessites places buides de veritat, hauríes de usar un array d'objectes (`Integer[]`), que veuràs en la U11 amb les col·leccions.
...
📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/05-arrays) · **Anterior:** [06 · Aplicacions dels arrays](/ApuntesProgramacion/va/05-arrays/06-aplicaciones-arrays) · **Següent:** [08 · Array-revelde: errors comuns i depuració](/ApuntesProgramacion/va/05-arrays/08-array-revelde)