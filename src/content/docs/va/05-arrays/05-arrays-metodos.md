...
> 🗺️ **Estàs en:** 🅿️ **U05 · Arrays** → 05 · Arrays i mètodes
...
Ací se't cauran les ulleres (o se't posaran de moda). En la U08 vas vore que Java passa els arguments **per valor**. Però els arrays semblen arribar per referència... La clau: es passa per valor la **còpia de la referència**. L'array no es copia; només es copia l'adreça on és.
...
📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/05-arrays) · **Anterior:** [04 · La classe Arrays: la teua navalla suïssa](/ApuntesProgramacion/va/05-arrays/04-clase-arrays) · **Següent:** [06 · Aplicacions dels arrays](/ApuntesProgramacion/va/05-arrays/06-aplicaciones-arrays)