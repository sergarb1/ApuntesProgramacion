...
> 🗺️ **Estàs en:** 🅿️ **U05 · Arrays** → 08 · Array-revelde: errors comuns i depuració
...
📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/05-arrays) · **Anterior:** [07 · Be the Code: l'aparcament es gestiona](/ApuntesProgramacion/va/05-arrays/07-be-the-code) · **Següent:** [09 · Repàs interactiu](/ApuntesProgramacion/va/05-arrays/09-repaso-interactivo)