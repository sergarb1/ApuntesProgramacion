...
> 🗺️ **Estàs en:** 🅿️ **U05 · Arrays** → 01 · Arrays: l'aparcament de dades
...
> 🕶️ **Don Tip:** els arrays tenen grandària fixa. Una vegada creats, no pots afegir ni traure elements. Si ho necessites, se'n crea un altre i es copia. En la U11 veuràs les col·leccions, que solucionen això.
...
📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/05-arrays) · **Anterior:** [Índex de la unitat](/ApuntesProgramacion/va/05-arrays) · **Següent:** [02 · Recórrer arrays: for i for-each](/ApuntesProgramacion/va/05-arrays/02-recorrer-arrays)