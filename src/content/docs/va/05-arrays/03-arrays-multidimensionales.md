...
> 🗺️ **Estàs en:** 🅿️ **U05 · Arrays** → 03 · Arrays multidimensionals
...
📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/05-arrays) · **Anterior:** [02 · Recórrer arrays: for i for-each](/ApuntesProgramacion/va/05-arrays/02-recorrer-arrays) · **Següent:** [04 · La classe Arrays: la teua navalla suïssa](/ApuntesProgramacion/va/05-arrays/04-clase-arrays)