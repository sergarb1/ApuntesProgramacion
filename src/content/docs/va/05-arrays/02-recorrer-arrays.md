...
> 🗺️ **Estàs en:** 🅿️ **U05 · Arrays** → 02 · Recórrer arrays: for i for-each
...
| Recórrer una col·lecció (`ArrayList`, `HashSet`...) | `for-each` (U11 Col·leccions) |
...
📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/05-arrays) · **Anterior:** [01 · Arrays: l'aparcament de dades](/ApuntesProgramacion/va/05-arrays/01-arrays-basicos) · **Següent:** [03 · Arrays multidimensionals](/ApuntesProgramacion/va/05-arrays/03-arrays-multidimensionales)