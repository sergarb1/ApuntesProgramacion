...
- Treballar amb **Visual Studio Code** (o el teu IDE favorit) i conéixer el teu flux de treball diari.
...
|---|---|---|
| [01 · Què és Java?](/ApuntesProgramacion/va/02-introduccion/01-que-es-java) | Història, bytecode, la trilogia JVM/JRE/JDK | Tots |
| [02 · Instal·lació del JDK](/ApuntesProgramacion/va/02-introduccion/02-instalacion-jdk) | Eclipse Temurin, VS Code, Extension Pack, `java -version`, PATH | Tots |
| [03 · El teu primer programa](/ApuntesProgramacion/va/02-introduccion/03-hola-mundo) | Hola Món, estructura, el mètode `main` | Tots |
| [04 · El depurador](/ApuntesProgramacion/va/02-introduccion/04-depurador) | Breakpoints, step over/into, watch | Tots |
| [05 · Comentaris i documentació](/ApuntesProgramacion/va/02-introduccion/05-comentarios) | `//`, `/* */`, `/** */` i Javadoc | Tots |
| [06 · Arguments de línia de comandes](/ApuntesProgramacion/va/02-introduccion/06-argumentos) | L'array `args`, com llegir-lo i usar-lo | Tots |
| [07 · El compilador i els seus errors](/ApuntesProgramacion/va/02-introduccion/07-errores-compilador) | Compilar vs executar, errors típics del novat | Tots |
| [08 · VS Code i el teu flux de treball](/ApuntesProgramacion/va/02-introduccion/08-ide-flujo-trabajo) | Projectes, dreceres, crear/executar/depurar | Tots |
| [09 · Repàs interactiu](/ApuntesProgramacion/va/02-introduccion/09-repaso-interactivo) | Sé el Código, Fireside, Qui Soc, Laboratori, Crucigrama… | Tots |
...
> 📌 El depurador que es veu en el punt 4 posa les bases del RA3 (programes provats i depurats), que es completa en la U04.
