...
> 🗺️ **Estàs en:** 🔒 **U08 · Visibilitat, Encapsulació i Static** → 09 · Repàs interactiu
...
**PROXIMAMENT EN U09:** Herència, Polimorfisme i Interfícies. El moment en què les teues classes **es miren als ulls i es diuen "mira, això ho compartim"**. 🧬

---

📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/08-visibilidad-encapsulacion-static) · **Anterior:** [08 · Be the Code: encapsula la teua classe](/ApuntesProgramacion/va/08-visibilidad-encapsulacion-static/08-be-the-code) · **Següent:** **[U09 · Herència, Polimorfisme i Interfícies](/ApuntesProgramacion/va/09-herencia-polimorfismo-interfaces)**