...
> 🗺️ **Estàs en:** 🎯 **U122 · Programació Funcional** → 04 · Streams: el flux de dades
...
Fins ara, per a treballar amb una llista de la U11 escrivies `for (String s : lista)` i dins feies la màgia. El stream és una altra filosofia: en comptes de dir-li a Java **com** recórrer (bucle, índex, iterador), li dius **què** vols aconseguir i ell munta la cinta. Tu dissenyes el flux; Java mou els paquets.
...
- `lista.stream()` — la font més comuna: qualsevol col·lecció de la U11 té este mètode.
- `Stream.of(a, b, c)` — quan vols un flux a partir de diversos valors sense muntar una llista.
- `Arrays.stream(array)` — per a convertir un array de la U05 en flux.
...
📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/13-programacion-funcional) · **Anterior:** [03 · Referències a mètodes: la drecera `::`](/ApuntesProgramacion/va/13-programacion-funcional/03-referencias-metodos) · **Següent:** [05 · Operacions intermèdies: filter, map, distinct, sorted, limit](/ApuntesProgramacion/va/13-programacion-funcional/05-streams-intermedias)