...
> 🗺️ **Estàs en:** 🎯 **U122 · Programació Funcional** → 01 · Lambdes: funcions que viatgen soles
...
En la U11 vas vore les col·leccions i en la U12 els genèrics i els mapes. Tot genial. Però per a recórrer-les sempre hi havia una constant: els bucles i els mètodes un darrere l'altre. Hui canvia la jugada: les funcions deixen d'estar encadenades a una classe i comencen a **viatjar soles**.
...
📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/13-programacion-funcional) · **Anterior:** — · **Següent:** [02 · Interfícies funcionals: Predicate, Function, Consumer, Supplier](/ApuntesProgramacion/va/13-programacion-funcional/02-interfaces-funcionales)