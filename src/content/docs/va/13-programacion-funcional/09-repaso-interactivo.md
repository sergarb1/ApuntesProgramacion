...
> 🗺️ **Estàs en:** 🎯 **U122 · Programació Funcional** → 09 · Repàs interactiu
...
> ❓ **Puc usar streams amb arrays, que en la U05 eren una altra cosa?**
...
**PROXIMAMENT EN U123:** Fitxers i Regex. Guarda els resultats dels teus streams en disc i busca patrons amb expressions regulars. 📁

---

📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/13-programacion-funcional) · **Anterior:** [08 · Optional: el que accepta l'absència](/ApuntesProgramacion/va/13-programacion-funcional/08-optional) · **Següent:** **[U123 · Fitxers i Regex](/ApuntesProgramacion/va/14-ficheros-regex)**