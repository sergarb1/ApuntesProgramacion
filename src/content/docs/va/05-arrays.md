...
Benvingut a l'aparcament. En les unitats anteriors vas aprendre a **decidir** (U04) i a **repetir**, però sempre guardant una cosa per variable. Fins hui. En esta unitat descobreixes els **arrays**: la forma de guardar centenars (o milions) de dades del mateix tipus sota un sol nom i de moure-les amb un bucle.
...
|---|---|---|
| [01 · Arrays: l'aparcament de dades](/ApuntesProgramacion/va/05-arrays/01-arrays-basicos) | Crear arrays, índexs, `length` i el primer BOOM | Tots |
| [02 · Recórrer arrays: for i for-each](/ApuntesProgramacion/va/05-arrays/02-recorrer-arrays) | El duo inseparable i la variant peresosa de només lectura | Tots |
| [03 · Arrays multidimensionals](/ApuntesProgramacion/va/05-arrays/03-arrays-multidimensionales) | Arrays de arrays, files, columnes i bucles niats | Tots |
| [04 · La classe Arrays: la teua navalla suïssa](/ApuntesProgramacion/va/05-arrays/04-clase-arrays) | `toString`, `sort`, `binarySearch`, `copyOf`, `fill`, `equals` | Tots |
| [05 · Arrays i mètodes](/ApuntesProgramacion/va/05-arrays/05-arrays-metodos) | Passar arrays per referència i tornar-los | Tots |
| [06 · Aplicacions dels arrays](/ApuntesProgramacion/va/05-arrays/06-aplicaciones-arrays) | Arrays de String, de char, d'objectes i dades en taula | Tots |
| [07 · Be the Code: l'aparcament es gestiona](/ApuntesProgramacion/va/05-arrays/07-be-the-code) | Programar invers, cerques i compactar a mà | Tots |
| [08 · Array-revelde: errors comuns i depuració](/ApuntesProgramacion/va/05-arrays/08-array-revelde) | La galeria de monstres dels arrays i com caçar-los | Tots |
| [09 · Repàs interactiu](/ApuntesProgramacion/va/05-arrays/09-repaso-interactivo) | Sé el Código, Fireside, Qui Soc, Laboratori, Crucigrama… | Tots |
...
> 📌 Els arrays són la base de tot el que ve: els algoritmes de la U06 busquen i ordenen arrays, i quan un aparcament de grandària fixa se't queda menut, les col·leccions de la U11 (ArrayList, LinkedList...) prenen el relleu. Aprendre arrays a fons hui és la inversió que rendeix durant tot el curs.
