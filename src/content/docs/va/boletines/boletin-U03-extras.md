...
> 🧭 **I si et quedes amb ganes?** Quan domines les estructures de control (U04) podràs tornar a estos problemes amb `for` i `switch` per a fer solucions més elegants. El material no es perd: es reutilitza.