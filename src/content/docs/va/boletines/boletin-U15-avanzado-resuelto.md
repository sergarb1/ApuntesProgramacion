...
`Properties` carrega el parell clau-valor i `getProperty("url")` el recupera. Dues excepcions conviuen ací: la `IOException` de llegir el fitxer (U123) i la `SQLException` de connectar. I les credencials no viatgen en el codi: és el manament 6 del decàleg.
