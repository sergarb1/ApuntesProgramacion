...
Usa un `HashMap<Integer, Integer>` (el veuràs en la U12, però ja pots usar-lo) per a portar el compte de quantes voltes ha aparegut cada valor. Només afig l'element a la resposta si el seu comptador encara no ha arribat a `n`.
