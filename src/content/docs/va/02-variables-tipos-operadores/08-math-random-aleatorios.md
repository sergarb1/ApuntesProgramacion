---
title: 08 — Math.random() i nombres aleatoris
...
> 🗺️ **Estàs en:** 🔤 **U02 · Variables, Tipus i Operadors** → 08 · Math.random() i nombres aleatoris
...
📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/02-variables-tipos-operadores) · **Anterior:** [07 · Consola: eixida amb format i errors d'entrada](/ApuntesProgramacion/va/02-variables-tipos-operadores/07-consola-salida-formateada) · **Següent:** [09 · Mètodes útils de String](/ApuntesProgramacion/va/02-variables-tipos-operadores/09-metodos-string)