...
> 🗺️ **Estàs en:** 🌐 **U15 · Servir i Consumir APIs amb Web** → 03 · Servint HTML
...
📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/15-apis-web) · **Anterior:** [02 · Servidor web mínim amb HttpServer](/ApuntesProgramacion/va/15-apis-web/02-servidor-minimo) · **Següent:** [04 · Paràmetres GET i formularis POST](/ApuntesProgramacion/va/15-apis-web/04-get-post)