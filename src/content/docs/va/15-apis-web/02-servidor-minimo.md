...
> 🗺️ **Estàs en:** 🌐 **U15 · Servir i Consumir APIs amb Web** → 02 · Servidor web mínim amb HttpServer
...
📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/15-apis-web) · **Anterior:** [01 · El protocol HTTP en 30 segons](/ApuntesProgramacion/va/15-apis-web/01-protocolo-http) · **Següent:** [03 · Servint HTML](/ApuntesProgramacion/va/15-apis-web/03-sirviendo-html)