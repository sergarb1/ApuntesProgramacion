...
> 🗺️ **Estàs en:** 🌐 **U15 · Servir i Consumir APIs amb Web** → 06 · Mini projecte: gestor de tasques (API REST)
...
📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/15-apis-web) · **Anterior:** [05 · Tornant JSON: com una API de veritat](/ApuntesProgramacion/va/15-apis-web/05-devolviendo-json) · **Següent:** [07 · Consumir APIs externes amb HttpClient](/ApuntesProgramacion/va/15-apis-web/07-httpclient)