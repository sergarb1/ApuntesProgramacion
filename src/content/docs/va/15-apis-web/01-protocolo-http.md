...
> 🗺️ **Estàs en:** 🌐 **U15 · Servir i Consumir APIs amb Web** → 01 · El protocol HTTP en 30 segons
...
📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/15-apis-web) · **Anterior:** — · **Següent:** [02 · Servidor web mínim amb HttpServer](/ApuntesProgramacion/va/15-apis-web/02-servidor-minimo)