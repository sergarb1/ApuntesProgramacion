---
title: "U124 — Connexió a Bases de Dades amb JDBC"
...
En la U123 vas tancar el tracte amb els **fitxers**: guardar i llegir informació al disc. Hui pugem de nivell. Eixa informació deixa de viure en un fitxer solt i passa a una **base de dades relacional**, amb les seues taules, les seues claus i les seues regles. I Java, és clar, hi parlarà. La ferramenta es diu **JDBC** (Java Database Connectivity) i és el pont oficial entre el teu codi i qualsevol base de dades amb controlador.
...
|---|---|---|
| [01 · Què és JDBC](/ApuntesProgramacion/va/15-conexion-bases-datos/01-que-es-jdbc) | JDBC, SQLite i la dependència Maven que ho posa tot en marxa | Tots |
| [02 · Connexió a SQLite](/ApuntesProgramacion/va/15-conexion-bases-datos/02-conexion) | Els 5 passos del ritual i la interfície `Connection` | Tots |
| [03 · Statement i ResultSet](/ApuntesProgramacion/va/15-conexion-bases-datos/03-statement-resultset) | Executar consultes i processar files amb `next()` i `getXxx` | Tots |
| [04 · CRUD complet](/ApuntesProgramacion/va/15-conexion-bases-datos/04-crud) | Inserir, llegir, actualitzar i esborrar amb `executeQuery` i `executeUpdate` | Tots |
| [05 · PreparedStatement i SQL injection](/ApuntesProgramacion/va/15-conexion-bases-datos/05-preparedstatement) | Placeholders `?`, `setXxx` i la història de Bobby Tables | Tots |
| [06 · El patró DAO](/ApuntesProgramacion/va/15-conexion-bases-datos/06-pattern-dao) | Interfície + implementació: l'SQL no trepitja la teua lògica de negoci | Tots |
| [07 · Transaccions](/ApuntesProgramacion/va/15-conexion-bases-datos/07-transacciones) | `commit`, `rollback` i savepoints: tot o res | Tots |
| [08 · Bones pràctiques](/ApuntesProgramacion/va/15-conexion-bases-datos/08-buenas-practicas) | El decàleg del JDBC: recursos, files afectades i `WHERE` sempre | Tots |
| [09 · Repàs interactiu](/ApuntesProgramacion/va/15-conexion-bases-datos/09-repaso-interactivo) | Sé el Código, Fireside, Laboratori, Crucigrama i més | Tots |
...
<div class="ejercicio-links">
  <a href="/ApuntesProgramacion/va/boletines/boletin-u125-inicial" class="elink">🟢 Inicial per resoldre</a>
  <a href="/ApuntesProgramacion/va/boletines/boletin-u125-inicial-resuelto" class="elink">✅ Inicial resolt</a>
  <a href="/ApuntesProgramacion/va/boletines/boletin-u125-avanzado" class="elink">⭐ Avançat per resoldre</a>
  <a href="/ApuntesProgramacion/va/boletines/boletin-u125-avanzado-resuelto" class="elink">💪 Avançat resolt</a>
  <a href="/ApuntesProgramacion/va/boletines/boletin-u125-extras" class="elink">🔥 Extres</a>
</div>
...
> 📌 Esta unitat cobreix la **RA9** completa. El camí fins ací: la **U04** et va ensenyar les excepcions (i `SQLException` és checked, et perseguirà), la **U08/U09** et va donar les classes i interfícies amb què muntar els POJO i el DAO, i la **U123** et va deixar el `try-with-resources` llest per a tancar connexions. Tot el material anterior cobra sentit ara: és hora que els teus objectes dormisquen en una base de dades.

---

## 🚪 Per on comence?

- Vens de la U123 (fitxers) i vols l'essencial? → Comença en el [punt 1](/ApuntesProgramacion/va/15-conexion-bases-datos/01-que-es-jdbc) i el [punt 2](/ApuntesProgramacion/va/15-conexion-bases-datos/02-conexion): connectar és el 90% de la batalla.
- Ja connectes i vols gestionar dades? → Ves directe al [punt 4](/ApuntesProgramacion/va/15-conexion-bases-datos/04-crud) (el CRUD) i al [punt 5](/ApuntesProgramacion/va/15-conexion-bases-datos/05-preparedstatement) (fer-ho sense que et pirategen).
- Només vens a pels trucs? → Salta al [punt 5](/ApuntesProgramacion/va/15-conexion-bases-datos/05-preparedstatement) (l'SQL injection) i al [punt 8](/ApuntesProgramacion/va/15-conexion-bases-datos/08-buenas-practicas) (el decàleg).
- Vens a repassar? → Fes el [Repàs interactiu](/ApuntesProgramacion/va/15-conexion-bases-datos/09-repaso-interactivo) i després els [butlletins](/ApuntesProgramacion/va/boletines/boletin-u125-inicial).

**📍 Primer punt:** [01 · Què és JDBC](/ApuntesProgramacion/va/15-conexion-bases-datos/01-que-es-jdbc)  
**⏭️ En acabar la unitat, continua en [U125 · Servir i Consumir APIs amb Web](/ApuntesProgramacion/va/16-apis-web).**