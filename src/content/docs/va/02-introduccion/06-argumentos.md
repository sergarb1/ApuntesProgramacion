...
En la pràctica, l'array `args` apareix cada vegada que vulgues que el teu programa parle amb "el món exterior" **abans** d'arrancar. Més avant usaràs el `Scanner` (U03) per a demanar dades durant l'execució; els args són la via d'entrada **abans** d'executar-se.
