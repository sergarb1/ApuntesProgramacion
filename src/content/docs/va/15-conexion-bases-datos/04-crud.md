...
> 🗺️ **Estàs en:** 🗄️ **U124 · Connexió a BD amb JDBC** → 04 · CRUD complet
...
Ja saps connectar i consultar. Ara toca la rutina de tota aplicació amb base de dades: **inserir, llegir, actualitzar i esborrar**. És el pa de cada dia. Ací anem a construir l'exemple complet amb una taula `contactos`, un POJO (objecte Java, dels que vas conéixer a la U08) i els quatre mètodes. Prepara la cafetera.
...
Cada fila de la taula es converteix en un objecte Java. És la classe de sempre, amb atributs privats, getters i setters (la vas vore a la U08 i la U09):
...
Llegir tots els contactes. La consulta torna files i les convertim en una `List<Contacto>` (col·leccions, U11, fent de les seues):
...
📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/15-conexion-bases-datos) · **Anterior:** [03 · Statement i ResultSet](/ApuntesProgramacion/va/15-conexion-bases-datos/03-statement-resultset) · **Següent:** [05 · PreparedStatement i SQL injection](/ApuntesProgramacion/va/15-conexion-bases-datos/05-preparedstatement)