...
> 🗺️ **Estàs en:** 🗄️ **U124 · Connexió a BD amb JDBC** → 09 · Repàs interactiu
...
**PROXIMAMENT EN U125:** Servir i Consumir APIs amb Web. El moment en què el teu programa Java es posa un uniforme de cambrer: rep peticions HTTP i serveix dades en JSON. 🌐

---

📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/15-conexion-bases-datos) · **Anterior:** [08 · Bones pràctiques](/ApuntesProgramacion/va/15-conexion-bases-datos/08-buenas-practicas) · **Següent:** **[U125 · Servir i Consumir APIs amb Web](/ApuntesProgramacion/va/16-apis-web)**