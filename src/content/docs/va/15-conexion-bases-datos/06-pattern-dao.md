...
> 🗺️ **Estàs en:** 🗄️ **U124 · Connexió a BD amb JDBC** → 06 · El patró DAO
...
Al punt 4 vam escriure els quatre mètodes del CRUD. Si els deixes solts pel programa, l'SQL s'enganxa a la lògica de negoci com un xicle a la sabata: cada volta que canvie la base de dades, cal repassar el codi sencer buscant `getConnection`. El patró **DAO** posa ordre. És el tema de les interfícies que vas vore a la U09, aplicat a l'accés a dades.
...
> 💡 **Consell:** això és programar contra una interfície, que vas vore a la U09: declares el tipus `ContactoDAO` i crees la implementació concreta `ContactoDAOImpl`. Si la implementació canvia, el teu codi no es mou.
...
📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/15-conexion-bases-datos) · **Anterior:** [05 · PreparedStatement i SQL injection](/ApuntesProgramacion/va/15-conexion-bases-datos/05-preparedstatement) · **Següent:** [07 · Transaccions](/ApuntesProgramacion/va/15-conexion-bases-datos/07-transacciones)