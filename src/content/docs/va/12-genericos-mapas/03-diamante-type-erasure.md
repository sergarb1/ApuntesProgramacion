...
> 🗺️ **Estàs en:** 🗺️ **U12 · Genèrics i Mapes** → 03 · El diamant `<>` i type erasure
...
📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/12-genericos-mapas) · **Anterior:** [02 · La teua pròpia classe genèrica: `Caja<T>`](/ApuntesProgramacion/va/12-genericos-mapas/02-clases-genericas) · **Següent:** [04 · Mètodes genèrics: funcions per a tot tipus](/ApuntesProgramacion/va/12-genericos-mapas/04-metodos-genericos)