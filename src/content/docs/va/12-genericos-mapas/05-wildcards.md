...
> 🗺️ **Estàs en:** 🗺️ **U12 · Genèrics i Mapes** → 05 · Wildcards: `? extends T` i `? super T`
...
📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/12-genericos-mapas) · **Anterior:** [04 · Mètodes genèrics: funcions per a tot tipus](/ApuntesProgramacion/va/12-genericos-mapas/04-metodos-genericos) · **Següent:** [06 · HashMap: la guia telefònica](/ApuntesProgramacion/va/12-genericos-mapas/06-hashmap)