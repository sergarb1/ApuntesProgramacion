...
> 🗺️ **Estàs en:** 🗺️ **U12 · Genèrics i Mapes** → 07 · TreeMap, LinkedHashMap i altres mapes
...
📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/12-genericos-mapas) · **Anterior:** [06 · HashMap: la guia telefònica](/ApuntesProgramacion/va/12-genericos-mapas/06-hashmap) · **Següent:** [08 · Map vs List vs Set: tria la teua estructura](/ApuntesProgramacion/va/12-genericos-mapas/08-elegir-estructura-datos)