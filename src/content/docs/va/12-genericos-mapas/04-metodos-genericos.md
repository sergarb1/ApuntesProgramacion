...
> 🗺️ **Estàs en:** 🗺️ **U12 · Genèrics i Mapes** → 04 · Mètodes genèrics: funcions per a tot tipus
...
📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/12-genericos-mapas) · **Anterior:** [03 · El diamant `<>` i type erasure](/ApuntesProgramacion/va/12-genericos-mapas/03-diamante-type-erasure) · **Següent:** [05 · Wildcards: `? extends T` i `? super T`](/ApuntesProgramacion/va/12-genericos-mapas/05-wildcards)