---
title: "U08 — Herència, Polimorfisme i Interfícies"
...
> 🗺️ **El mapa del paquet:** 🚪 Benvinguda → ☕ U01 → 🔤 U02 → 🔀 U03 → 🧩 Fonaments → ⚡ Tècniques → 🏗️ POO → 🔒 U07 → **🧬 ACÍ ETS (U08)** → 📚 Col·leccions → 🗺️ Genèrics → 📁 Fitxers → 🗄️ JDBC → 🌐 APIs
...
|---|---|---|
| [01 · Herència: quan els teus fills seguixen els teus passos](/ApuntesProgramacion/va/08-herencia-polimorfismo-interfaces/01-herencia) | `extends`, què s'hereda i què no, IS-A vs HAS-A, l'arbre genealògic | Tots |
| [02 · super i @Override](/ApuntesProgramacion/va/08-herencia-polimorfismo-interfaces/02-super-override) | Cridar la superclasse, sobreescriure mètodes i encadenar constructors | Tots |
| [03 · protected i jerarquies de classes](/ApuntesProgramacion/va/08-herencia-polimorfismo-interfaces/03-protected-jerarquias) | El membre que només veu la família, arbres de classes i la classe base fràgil | Tots |
| [04 · Polimorfisme: el camaleó de la POO](/ApuntesProgramacion/va/08-herencia-polimorfismo-interfaces/04-polimorfismo) | Dynamic binding, referències polimòrfiques, col·leccions i paràmetres | Tots |
| [05 · instanceof i downcasting](/ApuntesProgramacion/va/08-herencia-polimorfismo-interfaces/05-instanceof-downcasting) | Preguntar qui eres i baixar la referència sense trencar res | Tots |
| [06 · La classe Object: el besavi de tot](/ApuntesProgramacion/va/08-herencia-polimorfismo-interfaces/06-clase-object) | `toString()`, `equals()` i `hashCode()` ben sobreescrits | Tots |
| [07 · Classes abstractes](/ApuntesProgramacion/va/08-herencia-polimorfismo-interfaces/07-clases-abstractas) | Esbossos que no s'instancien, mètodes abstractes i template method | Tots |
| [08 · Interfícies: el contracte que signes](/ApuntesProgramacion/va/08-herencia-polimorfismo-interfaces/08-interfaces) | `implements`, polimorfisme, mètodes `default` i abstract vs interface | Tots |
| [09 · Repàs interactiu](/ApuntesProgramacion/va/08-herencia-polimorfismo-interfaces/09-repaso-interactivo) | Sé el Código, Fireside, Laboratori, Crucigrama i més | Tots |
...
> 📌 El resultat d'aprenentatge **RA4** es recolza en la U06 (definir classes) i la U07 (visibilitat), i culmina ací amb herència i interfícies. La **RA7** es tanca amb esta unitat: jerarquies, sobrescriptura i contractes. Les col·leccions (RA6) arriben en la **U09**.

---

## 🚪 Per on comence?

- Cero coneixements? → Comença en el [punt 1](/ApuntesProgramacion/va/08-herencia-polimorfismo-interfaces/01-herencia). Només necessites el que vas vore en les unitats 06 i 07.
- Ja heredes i vols el contracte? → Ves directe al [punt 7](/ApuntesProgramacion/va/08-herencia-polimorfismo-interfaces/07-clases-abstractas) i al [punt 8](/ApuntesProgramacion/va/08-herencia-polimorfismo-interfaces/08-interfaces): ací està la mitat abstracta de la unitat.
- Només vens a per el polimorfisme? → Salta al [punt 4](/ApuntesProgramacion/va/08-herencia-polimorfismo-interfaces/04-polimorfismo) i al [punt 5](/ApuntesProgramacion/va/08-herencia-polimorfismo-interfaces/05-instanceof-downcasting).
- Vens a repassar? → Fes el [Repàs interactiu](/ApuntesProgramacion/va/08-herencia-polimorfismo-interfaces/09-repaso-interactivo) i després els [butlletins](/ApuntesProgramacion/va/boletines/boletin-u08-inicial).

**📍 Primer punt:** [01 · Herència: quan els teus fills seguixen els teus passos](/ApuntesProgramacion/va/08-herencia-polimorfismo-interfaces/01-herencia)  
**⏭️ En acabar la unitat, continua en [U09 · Arrays i Col·leccions](/ApuntesProgramacion/va/09-arrays-colecciones).