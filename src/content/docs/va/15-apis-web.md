...
> 📌 La **RA5** es completa amb la **U02** (consola i formats, CEs a i b) i la **U13** (fitxers i accés a arxius, CEs c, d i e). Esta unitat cobrix la cara web de l'entrada/eixida: HTTP com a protocol, HTML i JSON com a formats, i les llibreries `HttpServer` i `HttpClient` com a procediments del llenguatge.
