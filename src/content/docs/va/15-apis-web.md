---
title: "U15 — Servir i Consumir APIs amb Web"
...
> 🗺️ **El mapa del paquet:** 🚪 Benvinguda → ☕ U01 → 🔤 U02 → 🔀 U03 → 🅿️ U04 → 🧩 U05 → ⚡ U06 → 🏗️ U07 → 🔒 U08 → 🧬 U09 → 📚 U10 → 🗺️ 🎯 U12 → 📁 U13 → 🗄️ U14 → **🌐 ACÍ ETS (U15)**
...
|---|---|---|
| [01 · El protocol HTTP en 30 segons](/ApuntesProgramacion/va/15-apis-web/01-protocolo-http) | Petició-resposta, mètodes, codis d'estat i URLs | Tots |
| [02 · Servidor web mínim amb HttpServer](/ApuntesProgramacion/va/15-apis-web/02-servidor-minimo) | El teu primer servidor Java: `HttpServer`, `createContext` i `HttpExchange` | Tots |
| [03 · Servint HTML](/ApuntesProgramacion/va/15-apis-web/03-sirviendo-html) | Pàgines completes amb `Content-Type: text/html` i des de fitxer | Tots |
| [04 · Paràmetres GET i formularis POST](/ApuntesProgramacion/va/15-apis-web/04-get-post) | Llegir la query string i el cos de la petició | Tots |
| [05 · Tornant JSON: com una API de veritat](/ApuntesProgramacion/va/15-apis-web/05-devolviendo-json) | `application/json`, `fetch` des del frontend i per què front i back se separen | Tots |
| [06 · Mini projecte: gestor de tasques (API REST)](/ApuntesProgramacion/va/15-apis-web/06-proyecto-rest) | CRUD complet en memòria: GET, POST, PUT i DELETE | Tots |
| [07 · Consumir APIs externes amb HttpClient](/ApuntesProgramacion/va/15-apis-web/07-httpclient) | `HttpClient`, GET, `BodyHandlers` i parsejar JSON amb Gson | Tots |
| [08 · HttpClient avançat](/ApuntesProgramacion/va/15-apis-web/08-httpclient-avanzado) | POST, capçaleres, timeouts, `sendAsync` i PUT/DELETE | Tots |
| [09 · Repàs interactiu](/ApuntesProgramacion/va/15-apis-web/09-repaso-interactivo) | Sé el Código, Fireside, Laboratori, Crucigrama i més | Tots |
...
<div class="ejercicio-links">
  <a href="/ApuntesProgramacion/va/boletines/boletin-u15-inicial" class="elink">🟢 Inicial per resoldre</a>
  <a href="/ApuntesProgramacion/va/boletines/boletin-u15-inicial-resuelto" class="elink">✅ Inicial resolt</a>
  <a href="/ApuntesProgramacion/va/boletines/boletin-u15-avanzado" class="elink">⭐ Avançat per resoldre</a>
  <a href="/ApuntesProgramacion/va/boletines/boletin-u15-avanzado-resuelto" class="elink">💪 Avançat resolt</a>
  <a href="/ApuntesProgramacion/va/boletines/boletin-u15-extras" class="elink">🔥 Extres</a>
</div>
...
> 📌 La **RA5** es completa amb la **U02** (consola i formats, CEs a i b) i la **U13** (fitxers i accés a arxius, CEs c, d i e). Esta unitat cobreix la cara web de l'entrada/eixida: HTTP com a protocol, HTML i JSON com a formats, i les llibreries `HttpServer` i `HttpClient` com a procediments del llenguatge.

---

## 🚪 Per on comence?

- Vens de la U14 (JDBC) i vols l'essencial? → Comença en el [punt 1](/ApuntesProgramacion/va/15-apis-web/01-protocolo-http) i el [punt 2](/ApuntesProgramacion/va/15-apis-web/02-servidor-minimo): HTTP i el teu primer servidor.
- Ja saps servir i vols fer APIs? → Ves directe al [punt 5](/ApuntesProgramacion/va/15-apis-web/05-devolviendo-json) i al [punt 6](/ApuntesProgramacion/va/15-apis-web/06-proyecto-rest): JSON i el CRUD de tasques.
- Només vens a pel costat client? → Salta al [punt 7](/ApuntesProgramacion/va/15-apis-web/07-httpclient) i al [punt 8](/ApuntesProgramacion/va/15-apis-web/08-httpclient-avanzado): consumir APIs externes.
- Vens a repassar? → Fes el [Repàs interactiu](/ApuntesProgramacion/va/15-apis-web/09-repaso-interactivo) i després els [butlletins](/ApuntesProgramacion/va/boletines/boletin-u15-inicial).

**📍 Primer punt:** [01 · El protocol HTTP en 30 segons](/ApuntesProgramacion/va/15-apis-web/01-protocolo-http)
