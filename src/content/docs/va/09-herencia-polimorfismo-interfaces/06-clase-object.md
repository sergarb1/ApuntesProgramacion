...
> 🗺️ **Estàs en:** 🧬 **U09 · Herència, Polimorfisme i Interfícies** → 06 · La classe Object: el besavi de tot
...
> 💡 **Consell:** els quatre primers els uses cada dia. `clone()` millor oblida'l: usa un constructor de còpia (el vas vore en la U07).
