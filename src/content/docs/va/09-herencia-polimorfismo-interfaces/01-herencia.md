...
> 🗺️ **Estàs en:** 🧬 **U09 · Herència, Polimorfisme i Interfícies** → 01 · Herència: quan els teus fills seguixen els teus passos
...
La paraula clau és `extends` (la vas vore en la U08 per damunt, ara la domines):
...
📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/09-herencia-polimorfismo-interfaces) · **Anterior:** — · **Següent:** [02 · super i @Override](/ApuntesProgramacion/va/09-herencia-polimorfismo-interfaces/02-super-override)