...
> 🗺️ **Estàs en:** 🔒 **U07 · Visibilitat, Encapsulació i Static** → 01 · Visibilitat: l'art de no ensenyar-ho tot
...
En la U06 vas construir classes amb atributs i mètodes. Però hi ha una pregunta que no et vas fer: *i si algú li posa `edad = -666` al meu objecte Persona?* Si tot és públic, qualsevol pot fer-ho des de qualsevol lloc. I ací és on comença esta unitat: en el moment en què el teu codi necessita **portes**.
...
Ací tens una classe de la U06 escrita "a la bruta", amb tot públic:
...
📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/07-visibilidad-encapsulacion-static) · **Anterior:** [Índex de la unitat](/ApuntesProgramacion/va/07-visibilidad-encapsulacion-static) · **Següent:** [02 · public, private i protected](/ApuntesProgramacion/va/07-visibilidad-encapsulacion-static/02-public-private-protected)