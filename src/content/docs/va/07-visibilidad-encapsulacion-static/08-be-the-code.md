...
> 🗺️ **Estàs en:** 🔒 **U07 · Visibilitat, Encapsulació i Static** → 08 · Be the Code: encapsula la teua classe
...
És l'hora de ser tu el codi. La U06 ja et va ensenyar a dissenyar una classe; ara toca el treball fi: **blinda-la**. Agafem una classe que viola totes les regles i la transformem en una classe professional.
...
Fixa't en l'ordre del `if`: primer la condició de validesa, i dins del `else` l'avís. El `this` desambigua (paràmetre vs atribut, del punt 5 de la U06).
...
📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/07-visibilidad-encapsulacion-static) · **Anterior:** [07 · Constants de classe: static final](/ApuntesProgramacion/va/07-visibilidad-encapsulacion-static/07-constantes-static-final) · **Següent:** [09 · Repàs interactiu](/ApuntesProgramacion/va/07-visibilidad-encapsulacion-static/09-repaso-interactivo)