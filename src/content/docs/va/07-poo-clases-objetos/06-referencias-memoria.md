...
> 🗺️ **Estàs en:** 🏗️ **U07 · POO: Classes i Objectes** → 06 · Referències, null i memòria
...
> ⚠️ **Advertència:** este és el clàssic que cau en els exàmens "Què imprimeix?". La regla: **copiar una variable d'objecte copia l'adreça, no l'objecte**. Si vols una còpia independent, hauries de crear un objecte nou (`new`) i copiar atribut a atribut (o usar el que veuràs en la U10).
...
📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/07-poo-clases-objetos) · **Anterior:** [05 · La paraula clau this](/ApuntesProgramacion/va/07-poo-clases-objetos/05-this) · **Següent:** [07 · Sobrecàrrega i pas per valor](/ApuntesProgramacion/va/07-poo-clases-objetos/07-sobrecarga-paso-valor)