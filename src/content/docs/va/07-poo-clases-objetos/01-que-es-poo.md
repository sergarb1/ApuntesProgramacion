...
> ⚠️ **Advertència:** no t'estresses amb els pilars 2, 3 i 4. Esta unitat et dona els fonaments; els altres els alcem en la U08 i la U09. Ací mana l'abstracció i el naixement de les classes.
...
4. L'**encapsulació** en la U08 i l'**herència** (i el polimorfisme) en la U09.
...
📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/07-poo-clases-objetos) · **Anterior:** [Índex de la unitat](/ApuntesProgramacion/va/07-poo-clases-objetos) · **Següent:** [02 · Classes i objectes: el tallagalletas i les galetes](/ApuntesProgramacion/va/07-poo-clases-objetos/02-clases-objetos)