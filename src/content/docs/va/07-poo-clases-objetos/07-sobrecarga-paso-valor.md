...
> 🗺️ **Estàs en:** 🏗️ **U07 · POO: Classes i Objectes** → 07 · Sobrecàrrega i pas per valor
...
📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/07-poo-clases-objetos) · **Anterior:** [06 · Referències, null i memòria](/ApuntesProgramacion/va/07-poo-clases-objetos/06-referencias-memoria) · **Següent:** [08 · Be the Code: dissenya la teua classe](/ApuntesProgramacion/va/07-poo-clases-objetos/08-be-the-code)