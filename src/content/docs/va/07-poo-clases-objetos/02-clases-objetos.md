...
> 🗺️ **Estàs en:** 🏗️ **U07 · POO: Classes i Objectes** → 02 · Classes i objectes: el tallagalletas i les galetes
...
📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/07-poo-clases-objetos) · **Anterior:** [01 · Què és la POO](/ApuntesProgramacion/va/07-poo-clases-objetos/01-que-es-poo) · **Següent:** [03 · Atributs i mètodes](/ApuntesProgramacion/va/07-poo-clases-objetos/03-atributos-metodos)