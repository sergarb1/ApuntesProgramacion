...
> 🗺️ **Estàs en:** 🏗️ **U07 · POO: Classes i Objectes** → 05 · La paraula clau this
...
>
> **A:** No, i eixe és el clàssic dels exàmens. Els mètodes `static` no pertanyen a un objecte concret, així que no hi ha "este objecte" al qual assenyalar. Usar `this` en un `static` és error de compilació. Els `static` tenen la seua pròpia unitat: la U08.
...
📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/07-poo-clases-objetos) · **Anterior:** [04 · Constructors](/ApuntesProgramacion/va/07-poo-clases-objetos/04-constructores) · **Següent:** [06 · Referències, null i memòria](/ApuntesProgramacion/va/07-poo-clases-objetos/06-referencias-memoria)