...
> 🗺️ **Estàs en:** 📚 **U09 · Arrays i Col·leccions** → 02 · Recórrer arrays: for i for-each
...
| Recórrer una col·lecció (`ArrayList`, `HashSet`...) | `for-each` (punt 6) |
...
📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/09-arrays-colecciones) · **Anterior:** [01 · Arrays: l'aparcament de dades](/ApuntesProgramacion/va/09-arrays-colecciones/01-arrays-basicos) · **Següent:** [03 · Arrays multidimensionals](/ApuntesProgramacion/va/09-arrays-colecciones/03-arrays-multidimensionales)