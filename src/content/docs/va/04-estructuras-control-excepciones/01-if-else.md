...
En la U03 els teus programes jutjaven amb operadors relacionals i ternaris, però eixa justícia durava una línia. Ara arriba la justícia de debò: blocs sencers de codi que s'executen o no segons el que decidisca Java.
...
Del punt 4 de la U03 el coneixes com "un if-else en una línia". Ací està el seu moment de glòria:
...
📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/04-estructuras-control-excepciones) · **Anterior:** [Índex de la unitat](/ApuntesProgramacion/va/04-estructuras-control-excepciones) · **Següent:** [02 · switch](/ApuntesProgramacion/va/04-estructuras-control-excepciones/02-switch)
