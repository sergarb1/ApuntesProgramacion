...
> 🗺️ **Estàs en:** 🧩 **U04 · Algorítmica I: Fonaments** → 06 · Complexitat algorísmica: Big O
...
| O(n log n) | Quasi lineal | Ordenacions avançades (ho veuràs en la U05) | ~10.000 operacions |
...
📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/04-algoritmica-fundamentos) · **Anterior:** [05 · Ordenació per inserció](/ApuntesProgramacion/va/04-algoritmica-fundamentos/05-ordenacion-insercion) · **Següent:** [07 · Triar l'algoritme adequat](/ApuntesProgramacion/va/04-algoritmica-fundamentos/07-elegir-algoritmo)
