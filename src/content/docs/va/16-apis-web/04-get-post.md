...
> 🗺️ **Estàs en:** 🌐 **U125 · Servir i Consumir APIs amb Web** → 04 · Paràmetres GET i formularis POST
...
📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/16-apis-web) · **Anterior:** [03 · Servint HTML](/ApuntesProgramacion/va/16-apis-web/03-sirviendo-html) · **Següent:** [05 · Tornant JSON: com una API de veritat](/ApuntesProgramacion/va/16-apis-web/05-devolviendo-json)