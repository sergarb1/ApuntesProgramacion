...
> 🗺️ **Estàs en:** 🏗️ **U06 · POO: Classes i Objectes** → 08 · Be the Code: dissenya la teua classe
...
📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/06-poo-clases-objetos) · **Anterior:** [07 · Sobrecàrrega i pas per valor](/ApuntesProgramacion/va/06-poo-clases-objetos/07-sobrecarga-paso-valor) · **Següent:** [09 · Repàs interactiu](/ApuntesProgramacion/va/06-poo-clases-objetos/09-repaso-interactivo)