...
> 🗺️ **Estàs en:** 📚 **U10 · Col·leccions** → 01 · ArrayList i el Java Collections Framework
...
> 📝 **Nota:** el mateix amb la resta de primitius: `boolean` → `Boolean`, `double` → `Double`, `char` → `Character`... Si necessites saber més sobre genèrics i wrappers, la U11 els estira a fons.
...
📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/10-colecciones) · **Anterior:** — · **Següent:** [02 · LinkedList: la conga line](/ApuntesProgramacion/va/10-colecciones/02-linkedlist)