...
> 🗺️ **El mapa del paquet:** 🚪 Benvinguda → ☕ U01 → 🔤 U02 → 🔀 U03 → 🅿️ U04 → 🧩 U05 → ⚡ U06 → 🏗️ U07 → 🔒 U08 → 🧬 U09 → 📚 U10 → 🗺️ 🎯 U12 → 📁 U13 → **🗄️ ACÍ ETS (U14)** → 🌐 U15
...
|---|---|---|
| [01 · Què és JDBC](/ApuntesProgramacion/va/14-conexion-bases-datos/01-que-es-jdbc) | JDBC, SQLite i la dependència Maven que ho posa tot en marxa | Tots |
| [02 · Connexió a SQLite](/ApuntesProgramacion/va/14-conexion-bases-datos/02-conexion) | Els 5 passos del ritual i la interfície `Connection` | Tots |
| [03 · Statement i ResultSet](/ApuntesProgramacion/va/14-conexion-bases-datos/03-statement-resultset) | Executar consultes i processar files amb `next()` i `getXxx` | Tots |
| [04 · CRUD complet](/ApuntesProgramacion/va/14-conexion-bases-datos/04-crud) | Inserir, llegir, actualitzar i esborrar amb `executeQuery` i `executeUpdate` | Tots |
| [05 · PreparedStatement i SQL injection](/ApuntesProgramacion/va/14-conexion-bases-datos/05-preparedstatement) | Placeholders `?`, `setXxx` i la història de Bobby Tables | Tots |
...
**⏭️ En acabar la unitat, continua en [U15 · Servir i Consumir APIs amb Web](/ApuntesProgramacion/va/15-apis-web).**