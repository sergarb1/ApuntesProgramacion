...
> 🗺️ **Estàs en:** 🧩 **U06 · Algorítmica I: Fonaments** → 09 · Repàs interactiu
...
Per dos motius: en el **cas mitjà** fa menys intercanvis (desplaça, no intercanvia de tres en tres), i en **arrays quasi ordenats** és O(n) de veritat, mentre que la bombolla sense flag continua fent passades senceres. En la pràctica, amb arrays xicotets, la inserció nota la diferència. Amb arrays grans, cap de les dos: ací arriba la U07.
