...
> 🗺️ **Estàs en:** 🧩 **U06 · Algorítmica I: Fonaments** → 06 · Complexitat algorísmica: Big O
...
| O(n log n) | Quasi lineal | Ordenacions avançades (ho veuràs en la U07) | ~10.000 operacions |
...
📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/06-algoritmica-fundamentos) · **Anterior:** [05 · Ordenació per inserció](/ApuntesProgramacion/va/06-algoritmica-fundamentos/05-ordenacion-insercion) · **Següent:** [07 · Triar l'algoritme adequat](/ApuntesProgramacion/va/06-algoritmica-fundamentos/07-elegir-algoritmo)
