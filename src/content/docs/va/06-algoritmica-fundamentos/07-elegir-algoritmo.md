...
> 🗺️ **Estàs en:** 🧩 **U06 · Algorítmica I: Fonaments** → 07 · Triar l'algoritme adequat
...
- Si **ordenes una vegada i busques moltes vegades** → ordena amb alguna cosa decent (en la U07 veuràs com) i després usa binària. La inversió s'amortitza.
...
I si la teua botiga rebera **milers de consultes al dia** sobre el mateix catàleg? Llavors mereix la pena ordenar l'array una vegada (costa O(n²) amb el que saps hui, però en la U07 aprendràs més ràpid) i usar cerca binària en cada consulta. **Ordenar una vegada, buscar mil.**
...
2. **És gran i desordenat?** → No uses bombolla ni inserció. Espera a la U07 (QuickSort, MergeSort).
...
3. **Ni bombolla ni inserció**: amb 60.000 elements, O(n²) és un martiri. Toca esperar a la U07 (QuickSort/MergeSort, O(n log n)).
...
4. No usar bombolla ni inserció: el seu O(n²) seria un calvari. Espera a la U07 per a ordenar com cal.
...
3. Regla ràpida: xicotet o desordenat → lineal; gran i ordenat → binària; quasi ordenat → inserció; gran i desordenat → espera a la U07.
...
📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/06-algoritmica-fundamentos) · **Anterior:** [06 · Complexitat algorísmica: Big O](/ApuntesProgramacion/va/06-algoritmica-fundamentos/06-complejidad-big-o) · **Següent:** [08 · Be the Code: cerca binària des de zero](/ApuntesProgramacion/va/06-algoritmica-fundamentos/08-be-the-code)
