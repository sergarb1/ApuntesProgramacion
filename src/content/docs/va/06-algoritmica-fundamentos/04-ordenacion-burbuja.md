...
> 🗺️ **Estàs en:** 🧩 **U06 · Algorítmica I: Fonaments** → 04 · Ordenació bombolla
...
> 💡 **Consell:** la bombolla només s'usa en dos situacions: (1) estàs aprenent, i (2) saps que l'array tindrà menys de 50 elements. Per a tot lo demés hi ha alternatives millors (les veuràs en la U07).
...
4. Només per a aprendre, o amb arrays de **menys de ~50 elements**. Per a la resta, espera a la U07.
...
📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/06-algoritmica-fundamentos) · **Anterior:** [03 · Cerca binària](/ApuntesProgramacion/va/06-algoritmica-fundamentos/03-busqueda-binaria) · **Següent:** [05 · Ordenació per inserció](/ApuntesProgramacion/va/06-algoritmica-fundamentos/05-ordenacion-insercion)
