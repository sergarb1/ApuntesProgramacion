...
En la U05 vas vore els arrays: grandària fixa, accés per índex i prou treball manual per a créixer o encongir-se. Hui això s'acaba. Les **col·leccions** de Java són com les estructures de dades amb superpoders: creixen soles, s'encongeixen soles, rebutgen duplicats si vols, s'ordenen automàticament i es recorren sense que t'importe com estan construïdes per dins.
...
| [03 · HashSet: el porter sense duplicats](/ApuntesProgramacion/va/11-colecciones/03-hashset) | Sense repetits, sense ordre i O(1): `hashCode()` i `equals()` en acció | Tots |
| [04 · TreeSet i LinkedHashSet](/ApuntesProgramacion/va/11-colecciones/04-treeset-linkedhashset) | El que ordena sol i el que recorda l'ordre d'arribada | Tots |
| [05 · Iterator: el cambrer que pren nota](/ApuntesProgramacion/va/11-colecciones/05-iterator) | Recórrer qualsevol col·lecció i esborrar durant el recorregut sense `ConcurrentModificationException` | Tots |
| [06 · La classe Collections: la navalla suïssa](/ApuntesProgramacion/va/11-colecciones/06-collections) | `sort`, `reverse`, `shuffle`, `max`, `min`, `frequency`... en una línia | Tots |
| [07 · Triar la col·lecció adequada](/ApuntesProgramacion/va/11-colecciones/07-elegir-coleccion) | Ordre, duplicats i velocitat: les tres preguntes que decideixen | Tots |
| [08 · Be the Code: col·leccions en acció](/ApuntesProgramacion/va/11-colecciones/08-be-the-code) | Prediu l'eixida, caça el bug i tria la col·lecció a ull | Tots |
...
> 📌 La **RA6** es completa amb la **U05** (arrays, CE a), la **U12** (genèrics i mapes, CE f) i la **U123** (regex i XML, CEs g, h i i). Esta unitat cobreix el cor de les col·leccions: llistes, conjunts, iteradors i la llibreria `java.util`.
...
- Ja uses llistes i vols conjunts? → Ves directe al [punt 3](/ApuntesProgramacion/va/11-colecciones/03-hashset) i al [punt 4](/ApuntesProgramacion/va/11-colecciones/04-treeset-linkedhashset): duplicats fora.
- Només vens a pels trucs? → Salta al [punt 5](/ApuntesProgramacion/va/11-colecciones/05-iterator) (esborrar mentre recorres) i al [punt 7](/ApuntesProgramacion/va/11-colecciones/07-elegir-coleccion) (triar bé).
- Vens a repassar? → Fes el [Repàs interactiu](/ApuntesProgramacion/va/11-colecciones/09-repaso-interactivo) i després els [butlletins](/ApuntesProgramacion/va/boletines/boletin-u122-inicial).

**📍 Primer punt:** [01 · ArrayList i el Java Collections Framework](/ApuntesProgramacion/va/11-colecciones/01-arraylist-jcf)  
**⏭️ En acabar la unitat, continua en [U12 · Genèrics i Mapes](/ApuntesProgramacion/va/12-genericos-mapas).