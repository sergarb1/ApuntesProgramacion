...
> 🗺️ **Estás en:** 🧠 **U01 · Introducció al Pensament Computacional** → 01 · Què és un ordinador i un llenguatge de programació
...
> Aprendre la sintaxi de Java és fàcil (és com aprendre vocabulari). El repte real d'este curs no és memoritzar el diccionari, sinó saber **què dimonis vols dir-li a la màquina** per a resoldre un problema. I d'això tracta la resta d'esta Unitat 1! 🚀
