...
En la U06 vas vore que un algorisme es pot escriure amb bucles. Però hi ha problemes que s'*expressen* de manera molt més natural dient "este problema és com el mateix problema, però més xicotet". Per a eixos casos va nàixer la recursivitat: la tècnica estrella d'esta unitat.
...
📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/07-algoritmica-tecnicas) · **Anterior:** [Índex de la unitat](/ApuntesProgramacion/va/07-algoritmica-tecnicas) · **Següent:** [02 · Recursivitat: exemples clàssics](/ApuntesProgramacion/va/07-algoritmica-tecnicas/02-recursividad-ejemplos-clasicos)
