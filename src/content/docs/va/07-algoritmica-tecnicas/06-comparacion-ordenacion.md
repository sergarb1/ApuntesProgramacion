...
Ja has vist Quicksort i Mergesort, i en la U06 vas sobreviure a bombolla i inserció. Ara toca la pregunta d'examen, d'entrevista i de la vida real: *quin use?* La resposta sempre comença igual: *depén*.
...
📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/07-algoritmica-tecnicas) · **Anterior:** [05 · Mergesort](/ApuntesProgramacion/va/07-algoritmica-tecnicas/05-mergesort) · **Següent:** [07 · Be the Code: quicksort des de zero](/ApuntesProgramacion/va/07-algoritmica-tecnicas/07-be-the-code-quicksort)
