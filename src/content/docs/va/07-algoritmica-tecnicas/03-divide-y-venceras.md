...
L'estratègia és tan antiga com Juli Cèsar, però aplicada a algorismes continua sent igual d'efectiva. I sí, en la U06 ja la vas usar sense saber-ho: la **cerca binària** partix l'array per la meitat i descarta una part en cada pas. Eixe era el germen. Ara li posaràs nom i cognoms.
...
- **Cerca binària**: O(log n). Ja la coneixes de la U06.
...
📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/07-algoritmica-tecnicas) · **Anterior:** [02 · Recursivitat: exemples clàssics](/ApuntesProgramacion/va/07-algoritmica-tecnicas/02-recursividad-ejemplos-clasicos) · **Següent:** [04 · Quicksort](/ApuntesProgramacion/va/07-algoritmica-tecnicas/04-quicksort)
