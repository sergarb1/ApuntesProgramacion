...
> 🗺️ **Estàs en:** 🧬 **U08 · Herència, Polimorfisme i Interfícies** → 03 · protected i jerarquies de classes
...
En la U07 vas vore els quatre nivells de visibilitat. Ací descobrixes el matís que només cobra sentit amb herència: `protected`.
...
📚 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/08-herencia-polimorfismo-interfaces) · **Anterior:** [02 · super i @Override](/ApuntesProgramacion/va/08-herencia-polimorfismo-interfaces/02-super-override) · **Següent:** [04 · Polimorfisme: el camaleó de la POO](/ApuntesProgramacion/va/08-herencia-polimorfismo-interfaces/04-polimorfismo)