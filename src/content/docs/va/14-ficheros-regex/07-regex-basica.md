...
> 🗺️ **Estàs en:** 📁 **U123 · Fitxers i Expressions Regulars** → 07 · Expressions regulars: Pattern i Matcher
...
📁 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/14-ficheros-regex) · **Anterior:** [06 · Serialització: guardar objectes amb ObjectOutputStream](/ApuntesProgramacion/va/14-ficheros-regex/06-serializacion) · **Següent:** [08 · Regex en acció: matches, replaceAll, split i validacions](/ApuntesProgramacion/va/14-ficheros-regex/08-regex-aplicaciones)