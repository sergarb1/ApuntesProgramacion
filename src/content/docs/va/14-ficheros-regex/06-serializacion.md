...
> 🗺️ **Estàs en:** 📁 **U123 · Fitxers i Expressions Regulars** → 06 · Serialització: guardar objectes amb ObjectOutputStream
...
Per a llegir-lo de tornada, `ObjectInputStream` sobre `FileInputStream`. El resultat és un `Object`, així que necessites un **casting** (ja saps: el repartiment de l'`instanceof` de la U10):
...
¿Una llista d'objectes? També es serialitza d'una vegada. És la forma més còmoda de "persistir" les teues dades de la U11/U12:
...
📁 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/14-ficheros-regex) · **Anterior:** [05 · NIO: Files i Paths (la forma moderna)](/ApuntesProgramacion/va/14-ficheros-regex/05-nio-files-paths) · **Següent:** [07 · Expressions regulars: Pattern i Matcher](/ApuntesProgramacion/va/14-ficheros-regex/07-regex-basica)