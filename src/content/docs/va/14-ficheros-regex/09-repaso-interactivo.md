...
> 🗺️ **Estàs en:** 📁 **U123 · Fitxers i Expressions Regulars** → 09 · Repàs interactiu
...
**PROXIMAMENT EN U124:** Connexió a bases de dades amb JDBC. El moment en què els teus programes aprenen a parlar amb un gestor de bases de dades relacional. 🗄️

---

📁 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/14-ficheros-regex) · **Anterior:** [08 · Regex en acció: matches, replaceAll, split i validacions](/ApuntesProgramacion/va/14-ficheros-regex/08-regex-aplicaciones) · **Següent:** **[U124 · Connexió a BD amb JDBC](/ApuntesProgramacion/va/15-conexion-bases-datos)**