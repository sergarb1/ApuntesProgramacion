...
📁 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/13-ficheros-regex) · **Anterior:** [02 · Escriure i llegir text: FileWriter, FileReader i BufferedReader](/ApuntesProgramacion/va/13-ficheros-regex/02-escribir-leer-texto) · **Següent:** [04 · PrintWriter i Scanner + File](/ApuntesProgramacion/va/13-ficheros-regex/04-printwriter-scanner-file)