...
¿Una llista d'objectes? També es serialitza d'una vegada. És la forma més còmoda de "persistir" les teues dades de la U11:
...
📁 [Tornar a l'índex de la unitat](/ApuntesProgramacion/va/13-ficheros-regex) · **Anterior:** [05 · NIO: Files i Paths (la forma moderna)](/ApuntesProgramacion/va/13-ficheros-regex/05-nio-files-paths) · **Següent:** [07 · Expressions regulars: Pattern i Matcher](/ApuntesProgramacion/va/13-ficheros-regex/07-regex-basica)