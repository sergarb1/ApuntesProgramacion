...
> 🗺️ **Estás en:** 🗺️ **U12 · Genéricos y Mapas** → 05 · Wildcards: `? extends T` y `? super T`
...
📚 [Volver al índice de la unidad](/ApuntesProgramacion/12-genericos-mapas) · **Anterior:** [04 · Métodos genéricos: funciones para todo tipo](/ApuntesProgramacion/12-genericos-mapas/04-metodos-genericos) · **Siguiente:** [06 · HashMap: la guía telefónica](/ApuntesProgramacion/12-genericos-mapas/06-hashmap)