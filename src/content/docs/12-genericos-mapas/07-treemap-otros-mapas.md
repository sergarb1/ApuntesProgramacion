...
> 🗺️ **Estás en:** 🗺️ **U12 · Genéricos y Mapas** → 07 · TreeMap, LinkedHashMap y otros mapas
...
📚 [Volver al índice de la unidad](/ApuntesProgramacion/12-genericos-mapas) · **Anterior:** [06 · HashMap: la guía telefónica](/ApuntesProgramacion/12-genericos-mapas/06-hashmap) · **Siguiente:** [08 · Map vs List vs Set: elige tu estructura](/ApuntesProgramacion/12-genericos-mapas/08-elegir-estructura-datos)