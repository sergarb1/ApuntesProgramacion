...
> 🗺️ **Estás en:** 🗺️ **U12 · Genéricos y Mapas** → 03 · El diamante `<>` y type erasure
...
📚 [Volver al índice de la unidad](/ApuntesProgramacion/12-genericos-mapas) · **Anterior:** [02 · Tu propia clase genérica: `Caja<T>`](/ApuntesProgramacion/12-genericos-mapas/02-clases-genericas) · **Siguiente:** [04 · Métodos genéricos: funciones para todo tipo](/ApuntesProgramacion/12-genericos-mapas/04-metodos-genericos)