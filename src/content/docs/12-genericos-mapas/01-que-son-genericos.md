...
> 🗺️ **Estás en:** 🗺️ **U12 · Genéricos y Mapas** → 01 · Genéricos: el `<T>` que lo cambió todo
...
En la U11 viste `ArrayList<String>`, `HashSet<Integer>`... pero nadie te explicó de dónde sale ese `<String>`. Hoy es el día. Bienvenida o bienvenido a la unidad donde el compilador deja de ser un juez y se convierte en tu entrenador personal.
...
📚 [Volver al índice de la unidad](/ApuntesProgramacion/12-genericos-mapas) · **Anterior:** — · **Siguiente:** [02 · Tu propia clase genérica: `Caja<T>`](/ApuntesProgramacion/12-genericos-mapas/02-clases-genericas)