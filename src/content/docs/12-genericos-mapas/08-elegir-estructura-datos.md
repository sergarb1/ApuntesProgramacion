...
> 🗺️ **Estás en:** 🗺️ **U12 · Genéricos y Mapas** → 08 · Map vs List vs Set: elige tu estructura
...
En la U11 dominaste las listas y los conjuntos. En los puntos 6 y 7, los mapas. Ahora toca el cierre de las tres familias: saber cuál usar en cada situación. No hay estructura "mejor": hay una estructura para cada problema. Este punto es tu brújula definitiva.
...
¿Ves el patrón? La primera pregunta es la nueva de esta unidad: **¿necesitas asociar?** Si la respuesta es sí, entras en el mundo de los mapas y solo decides entre orden natural, orden de llegada o velocidad pura. Si es no, vuelves a la lógica de la U11.
...
📚 [Volver al índice de la unidad](/ApuntesProgramacion/12-genericos-mapas) · **Anterior:** [07 · TreeMap, LinkedHashMap y otros mapas](/ApuntesProgramacion/12-genericos-mapas/07-treemap-otros-mapas) · **Siguiente:** [09 · Repaso interactivo](/ApuntesProgramacion/12-genericos-mapas/09-repaso-interactivo)