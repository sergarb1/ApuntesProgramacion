...
> 🗺️ **Estás en:** 🗺️ **U12 · Genéricos y Mapas** → 04 · Métodos genéricos: funciones para todo tipo
...
📚 [Volver al índice de la unidad](/ApuntesProgramacion/12-genericos-mapas) · **Anterior:** [03 · El diamante `<>` y type erasure](/ApuntesProgramacion/12-genericos-mapas/03-diamante-type-erasure) · **Siguiente:** [05 · Wildcards: `? extends T` y `? super T`](/ApuntesProgramacion/12-genericos-mapas/05-wildcards)