...
> 🗺️ **Estás en:** 🔒 **U08 · Visibilidad, Encapsulación y Static** → 02 · public, private y protected
...
Es como las historias vergonzosas de la familia. Tus primos (mismo paquete) y tus hijos (subclases) pueden acceder. Pero un desconocido de otro paquete... no. En la U09 (herencia) lo exprimirás de verdad; por ahora, quédate con la idea: *protegido para la familia*.
...
📚 [Volver al índice de la unidad](/ApuntesProgramacion/08-visibilidad-encapsulacion-static) · **Anterior:** [01 · Visibilidad: el arte de no enseñarlo todo](/ApuntesProgramacion/08-visibilidad-encapsulacion-static/01-visibilidad) · **Siguiente:** [03 · Encapsulación: el pilar de la POO](/ApuntesProgramacion/08-visibilidad-encapsulacion-static/03-encapsulacion)