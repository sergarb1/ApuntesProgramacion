...
> 🗺️ **Estás en:** 🔒 **U08 · Visibilidad, Encapsulación y Static** → 09 · Repaso interactivo
...
**PRÓXIMAMENTE EN U09:** Herencia, Polimorfismo e Interfaces. El momento en el que tus clases **se miran a los ojos y se dicen "mira, esto lo compartimos"**. 🧬

---

📚 [Volver al índice de la unidad](/ApuntesProgramacion/08-visibilidad-encapsulacion-static) · **Anterior:** [08 · Be the Code: encapsula tu clase](/ApuntesProgramacion/08-visibilidad-encapsulacion-static/08-be-the-code) · **Siguiente:** **[U09 · Herencia, Polimorfismo e Interfaces](/ApuntesProgramacion/09-herencia-polimorfismo-interfaces)**