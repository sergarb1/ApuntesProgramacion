...
Cada atributo tiene un tipo (que ya dominas de la U03) y describe una propiedad del objeto. Cuando creas un coche con `new Coche()`, ese coche concreto tendrá **su propia copia** de los cuatro atributos. Otro coche, otras copias. Cada galleta lleva sus pepitas.

> 💡 **Tip:** los atributos se declaran con los mismos tipos que las variables: `String`, `int`, `double`, `boolean`... Si dominas la U03, dominas la mitad de este punto.
...
📚 [Volver al índice de la unidad](/ApuntesProgramacion/08-poo-clases-objetos) · **Anterior:** [02 · Clases y objetos: el cortapastas y las galletas](/ApuntesProgramacion/08-poo-clases-objetos/02-clases-objetos) · **Siguiente:** [04 · Constructores](/ApuntesProgramacion/08-poo-clases-objetos/04-constructores)