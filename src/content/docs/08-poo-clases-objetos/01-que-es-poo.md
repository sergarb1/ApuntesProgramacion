...
2. **Encapsulación (U09):** cada objeto protege sus datos y decide quién puede tocarlos. Como una cuenta bancaria: el saldo no está tirado en la calle.
3. **Herencia (U10):** una clase puede "heredar" de otra. Un `Perro` es un `Animal` y, además, ladra.
4. **Polimorfismo (U10):** el mismo mensaje, distintas respuestas. Todos los animales "hacen sonido"; el perro ladra y el gato maúlla.

> ⚠️ **Advertencia:** no te estreses con los pilares 2, 3 y 4. Esta unidad te da los cimientos; los demás los levantamos en la U09 y la U10. Aquí manda la abstracción y el nacimiento de las clases.
...
> **Q:** ¿Qué pasa con el `main` que llevo escribiendo desde la U02? ¿Ahora no sirve?
>
...
4. La **encapsulación** en la U09 y la **herencia** (y el polimorfismo) en la U10.
...
📚 [Volver al índice de la unidad](/ApuntesProgramacion/08-poo-clases-objetos) · **Anterior:** [Índice de la unidad](/ApuntesProgramacion/08-poo-clases-objetos) · **Siguiente:** [02 · Clases y objetos: el cortapastas y las galletas](/ApuntesProgramacion/08-poo-clases-objetos/02-clases-objetos)