...
Esa es la convención de los **getters y setters**: métodos para leer (`getSaldo`) y modificar (`setSaldo`) atributos de forma controlada. Suena a burocracia, pero es la base de la **encapsulación**, y tiene su unidad entera: la U09. Aquí los verás de refilón; allí los dominarás.
...
**PRÓXIMAMENTE EN U09:** Visibilidad, encapsulación y `static`. El momento en el que tus objetos aprenden a decir "eso no se toca". 🔒
