...
>
> **A:** No, y ese es el clásico de los exámenes. Los métodos `static` no pertenecen a un objeto concreto, así que no hay "este objeto" al que señalar. Usar `this` en un `static` es error de compilación. Los `static` tienen su propia unidad: la U09.
...
📚 [Volver al índice de la unidad](/ApuntesProgramacion/08-poo-clases-objetos) · **Anterior:** [04 · Constructores](/ApuntesProgramacion/08-poo-clases-objetos/04-constructores) · **Siguiente:** [06 · Referencias, null y memoria](/ApuntesProgramacion/08-poo-clases-objetos/06-referencias-memoria)