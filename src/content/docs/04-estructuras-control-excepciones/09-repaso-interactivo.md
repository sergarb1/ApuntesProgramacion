...
*Y el colmo:* `if (x = 5)`. Con UN igual. ¡Eso no es una condición, es una asignación! Te lo digo desde la U03 y sigo viéndolo. El doble igual `==` se queda en casa cuando toca comparar.
