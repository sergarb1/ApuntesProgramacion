...
En la U03 tus programas juzgaban con operadores relacionales y ternarios, pero esa justicia duraba una línea. Ahora llega la justicia de verdad: bloques enteros de código que se ejecutan o no según lo que decida Java.
...
> ⚠️ **Advertencia:** no conviertas tus programas en las Torres Kio. Más de 3 niveles de anidamiento es señal de que estás haciendo las cosas raro: en la U06 aprenderás a aplanarlo.

---

## 🎚️ El ternario: el if de bolsillo

Del punto 4 de la U03 lo conoces como "un if-else en una línea". Aquí está su momento de gloria:
...
📚 [Volver al índice de la unidad](/ApuntesProgramacion/04-estructuras-control-excepciones) · **Anterior:** [Índice de la unidad](/ApuntesProgramacion/04-estructuras-control-excepciones) · **Siguiente:** [02 · switch](/ApuntesProgramacion/04-estructuras-control-excepciones/02-switch)
