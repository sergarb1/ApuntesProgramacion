...
En la U11 viste colecciones, genéricos y mapas: tus datos por fin viven en estructuras que el compilador controla y que se asocian con elegancia. Pero había una manera de recorrerlas: bucles, bucles y más bucles. ¿Y si te dijera que existe una forma de decirle a Java **QUÉ** quieres conseguir y que él se encargue del **CÓMO**?
...
> 📌 La **RA6** se completa con la **U05** (arrays, CE a), la **U11** (colecciones, genéricos y mapas, CEs b, c, d, e y f) y la **U13** (regex, CE g). Esta unidad añade la capa de **programación funcional**: procesa la información de las colecciones con lambdas, streams y `Optional`, reforzando los CEs b y c desde el enfoque declarativo.
