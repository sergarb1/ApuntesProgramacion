...
> 🗺️ **Estás en:** ⚡ **U06 · Algorítmica II: Técnicas** → 09 · Repaso interactivo
...
**PRÓXIMAMENTE EN U07:** POO: Clases y Objetos. El momento en el que tus programas dejan de ser funciones sueltas y se convierten en **ciudadanos con atributos y métodos**. 🏗️

---

📚 [Volver al índice de la unidad](/ApuntesProgramacion/06-algoritmica-tecnicas) · **Anterior:** [08 · Otras técnicas algorítmicas](/ApuntesProgramacion/06-algoritmica-tecnicas/08-otras-tecnicas-algoritmicas) · **Siguiente:** **[U07 · POO: Clases y Objetos](/ApuntesProgramacion/07-poo-clases-objetos)**