...
Bienvenido al aparcamiento. En las unidades anteriores aprendiste a **decidir** (U04) y a **repetir**, pero siempre guardando una cosa por variable. Hasta hoy. En esta unidad descubres los **arrays**: la forma de guardar cientos (o millones) de datos del mismo tipo bajo un solo nombre y de moverlos con un bucle.
...
|---|---|---|
| [01 · Arrays: el aparcamiento de datos](/ApuntesProgramacion/05-arrays/01-arrays-basicos) | Crear arrays, índices, `length` y el primer BOOM | Todos |
| [02 · Recorrer arrays: for y for-each](/ApuntesProgramacion/05-arrays/02-recorrer-arrays) | El dúo inseparable y la variante perezosa de solo lectura | Todos |
| [03 · Arrays multidimensionales](/ApuntesProgramacion/05-arrays/03-arrays-multidimensionales) | Arrays de arrays, filas, columnas y bucles anidados | Todos |
| [04 · La clase Arrays: tu navaja suiza](/ApuntesProgramacion/05-arrays/04-clase-arrays) | `toString`, `sort`, `binarySearch`, `copyOf`, `fill`, `equals` | Todos |
| [05 · Arrays y métodos](/ApuntesProgramacion/05-arrays/05-arrays-metodos) | Pasar arrays por referencia y devolverlos | Todos |
| [06 · Aplicaciones de los arrays](/ApuntesProgramacion/05-arrays/06-aplicaciones-arrays) | Arrays de String, de char, de objetos y datos en tabla | Todos |
| [07 · Be the Code: el parking se gestiona](/ApuntesProgramacion/05-arrays/07-be-the-code) | Programar inverso, búsquedas y compactar a mano | Todos |
| [08 · Array-revelde: errores comunes y depuración](/ApuntesProgramacion/05-arrays/08-array-revelde) | La galería de monstruos de los arrays y cómo cazarlos | Todos |
| [09 · Repaso interactivo](/ApuntesProgramacion/05-arrays/09-repaso-interactivo) | Sé el Código, Fireside, Quién Soy, Laboratorio, Crucigrama… | Todos |
...
> 📌 Los arrays son la base de todo lo que viene: los algoritmos de la U06 buscan y ordenan arrays, y cuando un parking de tamaño fijo se te queda pequeño, las colecciones de la U11 (ArrayList, LinkedList...) toman el relevo. Aprender arrays a fondo hoy es la inversión que renta durante todo el curso.
