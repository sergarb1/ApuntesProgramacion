...
> 🗺️ **Estás en:** 🗄️ **U124 · Conexión a BD con JDBC** → 09 · Repaso interactivo
...
**PROXIMAMENTE EN U125:** Servir y Consumir APIs con Web. El momento en que tu programa Java se pone un uniforme de camarero: recibe peticiones HTTP y sirve datos en JSON. 🌐

---

📚 [Volver al índice de la unidad](/ApuntesProgramacion/15-conexion-bases-datos) · **Anterior:** [08 · Buenas prácticas](/ApuntesProgramacion/15-conexion-bases-datos/08-buenas-practicas) · **Siguiente:** **[U125 · Servir y Consumir APIs con Web](/ApuntesProgramacion/16-apis-web)**