...
|---|---|---|
| [01 · La clase File: tu explorador de archivos](/ApuntesProgramacion/13-ficheros-regex/01-clase-file) | El GPS que localiza archivos sin leer su contenido | Todos |
| [02 · Escribir y leer texto: FileWriter, FileReader y BufferedReader](/ApuntesProgramacion/13-ficheros-regex/02-escribir-leer-texto) | El lápiz que no olvida y el lector que no se atraganta | Todos |
| [03 · try-with-resources: cerrar sin llorar](/ApuntesProgramacion/13-ficheros-regex/03-try-with-resources) | La puerta que se cierra sola: adiós al `close()` manual | Todos |
| [04 · PrintWriter y Scanner + File](/ApuntesProgramacion/13-ficheros-regex/04-printwriter-scanner-file) | El sargento que formatea y el pulpo que tokeniza | Todos |
| [05 · NIO: Files y Paths (la forma moderna)](/ApuntesProgramacion/13-ficheros-regex/05-nio-files-paths) | Leer, escribir y consultar archivos en una línea | Todos |
| [06 · Serialización: guardar objetos con ObjectOutputStream](/ApuntesProgramacion/13-ficheros-regex/06-serializacion) | Tu objeto entero en una maleta: `Serializable` | Todos |
| [07 · Expresiones regulares: Pattern y Matcher](/ApuntesProgramacion/13-ficheros-regex/07-regex-basica) | El molde, el texto y el infierno de las contrabarras | Todos |
| [08 · Regex en acción: matches, replaceAll, split y validaciones](/ApuntesProgramacion/13-ficheros-regex/08-regex-aplicaciones) | Validar correos, DNIs, teléfonos y extraer con grupos | Todos |
| [09 · Repaso interactivo](/ApuntesProgramacion/13-ficheros-regex/09-repaso-interactivo) | Sé el Código, Fireside, Laboratorio, Crucigrama y más | Todos |
...
> 📌 La **RA6** se completa con la **U05** (arrays, CE a), la **U11** (colecciones, genéricos y mapas, CEs b, c, d, e y f). Esta unidad aporta el CE g: las expresiones regulares.

---

## 🚪 ¿Por dónde empiezo?

- ¿Vienes de la U11 y quieres lo esencial? → Arranca en el [punto 1](/ApuntesProgramacion/13-ficheros-regex/01-clase-file) y el [punto 2](/ApuntesProgramacion/13-ficheros-regex/02-escribir-leer-texto): localizar y leer archivos de texto.
- ¿Ya sabes escribir y leer y quieres la forma moderna? → Salta al [punto 3](/ApuntesProgramacion/13-ficheros-regex/03-try-with-resources) (cerrar sin llorar) y al [punto 5](/ApuntesProgramacion/13-ficheros-regex/05-nio-files-paths) (NIO en una línea).
- ¿Solo vienes a por las regex? → Ve directo al [punto 7](/ApuntesProgramacion/13-ficheros-regex/07-regex-basica) y al [punto 8](/ApuntesProgramacion/13-ficheros-regex/08-regex-aplicaciones): el detective de patrones.
