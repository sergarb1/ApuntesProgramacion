---
title: "06 — ArrayList y el Java Collections Framework"
...
> 🗺️ **Estás en:** 📚 **U09 · Arrays y Colecciones** → 06 · ArrayList y el Java Collections Framework
...
Llegó el momento que los arrays estaban esperando: el parking se ha quedado pequeño y necesitas algo que crezca. Aquí empieza la segunda mitad de la unidad y, probablemente, la herramienta que más usarás en tu vida como programadora o programador.
...
> 📝 **Nota:** lo mismo con el resto de primitivos: `boolean` → `Boolean`, `double` → `Double`, `char` → `Character`... Si necesitas saber más sobre genéricos y wrappers, la U10 los estira a fondo.
...
📚 [Volver al índice de la unidad](/ApuntesProgramacion/09-arrays-colecciones) · **Anterior:** [05 · Arrays y métodos](/ApuntesProgramacion/09-arrays-colecciones/05-arrays-metodos) · **Siguiente:** [07 · LinkedList, HashSet y TreeSet](/ApuntesProgramacion/09-arrays-colecciones/07-linkedlist-hashset)