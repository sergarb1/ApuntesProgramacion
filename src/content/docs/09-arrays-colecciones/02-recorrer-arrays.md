...
> 🗺️ **Estás en:** 📚 **U09 · Arrays y Colecciones** → 02 · Recorrer arrays: for y for-each
...
| Recorrer una colección (`ArrayList`, `HashSet`...) | `for-each` (punto 6) |
...
📚 [Volver al índice de la unidad](/ApuntesProgramacion/09-arrays-colecciones) · **Anterior:** [01 · Arrays: el aparcamiento de datos](/ApuntesProgramacion/09-arrays-colecciones/01-arrays-basicos) · **Siguiente:** [03 · Arrays multidimensionales](/ApuntesProgramacion/09-arrays-colecciones/03-arrays-multidimensionales)