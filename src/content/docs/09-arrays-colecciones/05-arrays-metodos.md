...
> 🗺️ **Estás en:** 📚 **U09 · Arrays y Colecciones** → 05 · Arrays y métodos
...
Aquí se te van a caer las gafas (o se te van a poner de moda). En la U06 viste que Java pasa los argumentos **por valor**. Pero los arrays parecen llegar por referencia... La clave: se pasa por valor la **copia de la referencia**. El array no se copia; solo se copia la dirección donde está.
...
📚 [Volver al índice de la unidad](/ApuntesProgramacion/09-arrays-colecciones) · **Anterior:** [04 · La clase Arrays: tu navaja suiza](/ApuntesProgramacion/09-arrays-colecciones/04-clase-arrays) · **Siguiente:** [06 · ArrayList y el Java Collections Framework](/ApuntesProgramacion/09-arrays-colecciones/06-arraylist-jcf)