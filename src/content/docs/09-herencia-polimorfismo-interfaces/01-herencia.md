...
> 🗺️ **Estás en:** 🧬 **U09 · Herencia, Polimorfismo e Interfaces** → 01 · Herencia: cuando tus hijos siguen tus pasos
...
La palabra clave es `extends` (lo viste en la U08 por encima, ahora lo dominas):
...
📚 [Volver al índice de la unidad](/ApuntesProgramacion/09-herencia-polimorfismo-interfaces) · **Anterior:** — · **Siguiente:** [02 · super y @Override](/ApuntesProgramacion/09-herencia-polimorfismo-interfaces/02-super-override)