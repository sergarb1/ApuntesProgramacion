...
| [03 · HashSet: el portero sin duplicados](/ApuntesProgramacion/11-colecciones/03-hashset) | Sin repetidos, sin orden y O(1): `hashCode()` y `equals()` en acción | Todos |
| [04 · TreeSet y LinkedHashSet](/ApuntesProgramacion/11-colecciones/04-treeset-linkedhashset) | El que ordena solo y el que recuerda el orden de llegada | Todos |
| [05 · Iterator: el camarero que toma nota](/ApuntesProgramacion/11-colecciones/05-iterator) | Recorrer cualquier colección y borrar durante el recorrido sin `ConcurrentModificationException` | Todos |
| [06 · La clase Collections: la navaja suiza](/ApuntesProgramacion/11-colecciones/06-collections) | `sort`, `reverse`, `shuffle`, `max`, `min`, `frequency`... en una línea | Todos |
| [07 · Elegir la colección adecuada](/ApuntesProgramacion/11-colecciones/07-elegir-coleccion) | Orden, duplicados y velocidad: las tres preguntas que deciden | Todos |
| [08 · Be the Code: colecciones en acción](/ApuntesProgramacion/11-colecciones/08-be-the-code) | Predice la salida, caza el bug y elige la colección a ojo | Todos |
...
> 📌 La **RA6** se completa con la **U05** (arrays, CE a), la **U12** (genéricos y mapas, CE f) y la **U123** (regex y XML, CEs g, h e i). Esta unidad cubre el corazón de las colecciones: listas, conjuntos, iteradores y la librería `java.util`.
...
- ¿Ya usas listas y quieres conjuntos? → Ve directo al [punto 3](/ApuntesProgramacion/11-colecciones/03-hashset) y al [punto 4](/ApuntesProgramacion/11-colecciones/04-treeset-linkedhashset): duplicados fuera.
- ¿Solo vienes a por los trucos? → Salta al [punto 5](/ApuntesProgramacion/11-colecciones/05-iterator) (borrar mientras recorres) y al [punto 7](/ApuntesProgramacion/11-colecciones/07-elegir-coleccion) (elegir bien).
- ¿Vienes a repasar? → Haz el [Repaso interactivo](/ApuntesProgramacion/11-colecciones/09-repaso-interactivo) y después los [boletines](/ApuntesProgramacion/boletines/boletin-U122-inicial).

**📍 Primer punto:** [01 · ArrayList y el Java Collections Framework](/ApuntesProgramacion/11-colecciones/01-arraylist-jcf)  
**⏭️ Al acabar la unidad, continúa en [U12 · Genéricos y Mapas](/ApuntesProgramacion/12-genericos-mapas).