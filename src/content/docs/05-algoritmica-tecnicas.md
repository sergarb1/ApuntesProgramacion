---
title: "U05 — Algorítmica II: Técnicas"
...
> 🗺️ **El mapa del paquete:** 🚪 Bienvenida → ☕ U01 → 🔤 U02 → 🔀 U03 → 🧩 Fundamentos → **⚡ AQUÍ ESTÁS (U05)** → 🏗️ POO → 🔒 Visibilidad → 🧬 Herencia → 📚 Colecciones → 🗺️ Genéricos → 📁 Ficheros → 🗄️ JDBC → 🌐 APIs

---

Bienvenido, valiente explorador del stack de llamadas. En la U04 dominaste el arte de buscar y ordenar con bucles: búsqueda lineal, binaria, burbuja e inserción. Aprendiste a medir algoritmos con Big O y a no usar jamás burbuja en producción (lo prometiste). Pero los bucles se quedan cortos cuando el problema es *inherentemente* jerárquico. Y aquí es donde la programación se vuelve elegante.
...
|---|---|---|
| [01 · Recursividad](/ApuntesProgramacion/05-algoritmica-tecnicas/01-recursividad) | Caso base, caso recursivo, la pila de llamadas y el miedo al `StackOverflowError` | Todos |
| [02 · Recursividad: ejemplos clásicos](/ApuntesProgramacion/05-algoritmica-tecnicas/02-recursividad-ejemplos-clasicos) | Factorial, Fibonacci, palíndromos y torres de Hanói | Todos |
| [03 · Divide y vencerás](/ApuntesProgramacion/05-algoritmica-tecnicas/03-divide-y-venceras) | Dividir, conquistar y combinar: el patrón de Julio César | Todos |
| [04 · Quicksort](/ApuntesProgramacion/05-algoritmica-tecnicas/04-quicksort) | Partición, pivote, complejidades y por qué es tan famoso | Todos |
| [05 · Mergesort](/ApuntesProgramacion/05-algoritmica-tecnicas/05-mergesort) | División por la mitad, fusión y estabilidad | Todos |
| [06 · Comparación: cuándo usar cada ordenación](/ApuntesProgramacion/05-algoritmica-tecnicas/06-comparacion-ordenacion) | Guía práctica para elegir algoritmo y qué hay bajo `Arrays.sort()` | Todos |
| [07 · Be the Code: quicksort desde cero](/ApuntesProgramacion/05-algoritmica-tecnicas/07-be-the-code-quicksort) | Implementar Quicksort y Mergesort paso a paso, sin mirar | ⭐⭐⭐ |
| [08 · Otras técnicas algorítmicas](/ApuntesProgramacion/05-algoritmica-tecnicas/08-otras-tecnicas-algoritmicas) | Algoritmos voraces (greedy) y backtracking | ⭐⭐⭐ |
| [09 · Repaso interactivo](/ApuntesProgramacion/05-algoritmica-tecnicas/09-repaso-interactivo) | Sé el Código, Fireside, Laboratorio, Crucigrama y más | Todos |
...
- ¿Vienes de la U04 y estás fresco de Big O? → Arranca en el [punto 1](/ApuntesProgramacion/05-algoritmica-tecnicas/01-recursividad). Solo necesitas lo que viste en Fundamentos.
- ¿Lo tuyo es ver el resultado y no las tripas? → Salta al [punto 4](/ApuntesProgramacion/05-algoritmica-tecnicas/04-quicksort) y al [punto 5](/ApuntesProgramacion/05-algoritmica-tecnicas/05-mergesort) y vuelve después a la teoría de la recursividad.
- ¿Te flipan los retos? → Haz el [punto 7](/ApuntesProgramacion/05-algoritmica-tecnicas/07-be-the-code-quicksort) sin mirar el código de los puntos 4 y 5. Sufre con honor.
- ¿Vienes a repasar? → Haz el [Repaso interactivo](/ApuntesProgramacion/05-algoritmica-tecnicas/09-repaso-interactivo) y después los [boletines](/ApuntesProgramacion/boletines/boletin-u05-inicial).

**📍 Primer punto:** [01 · Recursividad](/ApuntesProgramacion/05-algoritmica-tecnicas/01-recursividad)  
**⏭️ Al acabar la unidad, continúa en [U06 · POO: Clases y Objetos](/ApuntesProgramacion/06-poo-clases-objetos).**
