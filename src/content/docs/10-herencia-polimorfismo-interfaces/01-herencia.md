...
La palabra clave es `extends` (lo viste en la U09 por encima, ahora lo dominas):
...
📚 [Volver al índice de la unidad](/ApuntesProgramacion/10-herencia-polimorfismo-interfaces) · **Anterior:** — · **Siguiente:** [02 · super y @Override](/ApuntesProgramacion/10-herencia-polimorfismo-interfaces/02-super-override)