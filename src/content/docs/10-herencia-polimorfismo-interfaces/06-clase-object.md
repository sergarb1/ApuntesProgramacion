...
> 🗺️ **Estás en:** 🧬 **U10 · Herencia, polimorfismo e interfaces** → 06 · La clase Object: el tatarabuelo
...
> 💡 **Consejo:** los cuatro primeros los usas a diario. `clone()` mejor olvídalo: usa un constructor de copia (lo viste en la U08).
...
📚 [Volver al índice de la unidad](/ApuntesProgramacion/10-herencia-polimorfismo-interfaces) · **Anterior:** [05 · instanceof y downcasting](/ApuntesProgramacion/10-herencia-polimorfismo-interfaces/05-instanceof-downcasting) · **Siguiente:** [07 · Clases abstractas](/ApuntesProgramacion/10-herencia-polimorfismo-interfaces/07-clases-abstractas)