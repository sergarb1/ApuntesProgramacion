...
> 🗺️ **Estás en:** 🏗️ **U07 · POO: Clases y Objetos** → 01 · Qué es la POO
...
2. **Encapsulación (U08):** cada objeto protege sus datos y decide quién puede tocarlos. Como una cuenta bancaria: el saldo no está tirado en la calle.
3. **Herencia (U09):** una clase puede "heredar" de otra. Un `Perro` es un `Animal` y, además, ladra.
4. **Polimorfismo (U09):** el mismo mensaje, distintas respuestas. Todos los animales "hacen sonido"; el perro ladra y el gato maúlla.

> ⚠️ **Advertencia:** no te estreses con los pilares 2, 3 y 4. Esta unidad te da los cimientos; los demás los levantamos en la U08 y la U09. Aquí manda la abstracción y el nacimiento de las clases.
...
4. La **encapsulación** en la U08 y la **herencia** (y el polimorfismo) en la U09.
...
📚 [Volver al índice de la unidad](/ApuntesProgramacion/07-poo-clases-objetos) · **Anterior:** [Índice de la unidad](/ApuntesProgramacion/07-poo-clases-objetos) · **Siguiente:** [02 · Clases y objetos: el cortapastas y las galletas](/ApuntesProgramacion/07-poo-clases-objetos/02-clases-objetos)