...
> 🗺️ **Estás en:** 🏗️ **U07 · POO: Clases y Objetos** → 07 · Sobrecarga y paso por valor
...
📚 [Volver al índice de la unidad](/ApuntesProgramacion/07-poo-clases-objetos) · **Anterior:** [06 · Referencias, null y memoria](/ApuntesProgramacion/07-poo-clases-objetos/06-referencias-memoria) · **Siguiente:** [08 · Be the Code: diseña tu clase](/ApuntesProgramacion/07-poo-clases-objetos/08-be-the-code)