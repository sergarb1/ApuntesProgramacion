...
> 🗺️ **Estás en:** 🅿️ **U05 · Arrays** → 02 · Recorrer arrays: for y for-each
...
| Recorrer una colección (`ArrayList`, `HashSet`...) | `for-each` (U11 Colecciones) |
...
📚 [Volver al índice de la unidad](/ApuntesProgramacion/05-arrays) · **Anterior:** [01 · Arrays: el aparcamiento de datos](/ApuntesProgramacion/05-arrays/01-arrays-basicos) · **Siguiente:** [03 · Arrays multidimensionales](/ApuntesProgramacion/05-arrays/03-arrays-multidimensionales)