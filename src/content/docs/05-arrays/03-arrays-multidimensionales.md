...
> 🗺️ **Estás en:** 🅿️ **U05 · Arrays** → 03 · Arrays multidimensionales
...
📚 [Volver al índice de la unidad](/ApuntesProgramacion/05-arrays) · **Anterior:** [02 · Recorrer arrays: for y for-each](/ApuntesProgramacion/05-arrays/02-recorrer-arrays) · **Siguiente:** [04 · La clase Arrays: tu navaja suiza](/ApuntesProgramacion/05-arrays/04-clase-arrays)