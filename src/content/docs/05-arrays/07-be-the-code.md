...
> 🗺️ **Estás en:** 🅿️ **U05 · Arrays** → 07 · Be the Code: el parking se gestiona
...
> 🕶️ **Don Tip:** pregunta siempre: ¿qué tipo de dato guarda este array? Un `int` no puede valer `null`; un `Integer` sí (pero eso es un objeto de la U11).
...
Si quisieras "vaciar" un `int[]`, tendrías que poner un valor de sentinela, por ejemplo `0` o `-1`. Y si de verdad necesitas plazas vacías de verdad, tendrías que usar un array de objetos (`Integer[]`), que verás en la U11 con las colecciones.
...
📚 [Volver al índice de la unidad](/ApuntesProgramacion/05-arrays) · **Anterior:** [06 · Aplicaciones de los arrays](/ApuntesProgramacion/05-arrays/06-aplicaciones-arrays) · **Siguiente:** [08 · Array-revelde: errores comunes y depuración](/ApuntesProgramacion/05-arrays/08-array-revelde)