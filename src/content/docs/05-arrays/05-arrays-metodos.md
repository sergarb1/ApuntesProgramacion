...
> 🗺️ **Estás en:** 🅿️ **U05 · Arrays** → 05 · Arrays y métodos
...
Aquí se te van a caer las gafas (o se te van a poner de moda). En la U08 viste que Java pasa los argumentos **por valor**. Pero los arrays parecen llegar por referencia... La clave: se pasa por valor la **copia de la referencia**. El array no se copia; solo se copia la dirección donde está.
...
Desde la U02 llevas escribiendo `main(String[] args)` sin pararte a pensar. ¡Es un método que recibe un array de Strings! Esos son los argumentos de línea de comandos:
...
📚 [Volver al índice de la unidad](/ApuntesProgramacion/05-arrays) · **Anterior:** [04 · La clase Arrays: tu navaja suiza](/ApuntesProgramacion/05-arrays/04-clase-arrays) · **Siguiente:** [06 · Aplicaciones de los arrays](/ApuntesProgramacion/05-arrays/06-aplicaciones-arrays)