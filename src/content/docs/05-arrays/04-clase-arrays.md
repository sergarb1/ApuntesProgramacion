...
> 🗺️ **Estás en:** 🅿️ **U05 · Arrays** → 04 · La clase Arrays: tu navaja suiza
...
Recuerda: como son métodos `static` (lo viste en la U08), se llaman con el nombre de la clase: `Arrays.xxx(array)`. No hace falta crear ningún objeto `Arrays` — de hecho, no puedes.
...
📚 [Volver al índice de la unidad](/ApuntesProgramacion/05-arrays) · **Anterior:** [03 · Arrays multidimensionales](/ApuntesProgramacion/05-arrays/03-arrays-multidimensionales) · **Siguiente:** [05 · Arrays y métodos](/ApuntesProgramacion/05-arrays/05-arrays-metodos)