...
> 🗺️ **Estás en:** 🚀 **U02 · Introducción a Java y el entorno de trabajo** → 06 · Argumentos de línea de órdenes
...
![Diagrama del array args: de la terminal al programa con sus índices y length](/ApuntesProgramacion/diagrams/u02-array-args.svg)
...
En la práctica, el array `args` aparece cada vez que quieras que tu programa hable con "el mundo exterior" **antes** de arrancar. Más adelante usarás el `Scanner` (U03) para pedir datos durante la ejecución; los args son la vía de entrada **antes** de ejecutarse.
