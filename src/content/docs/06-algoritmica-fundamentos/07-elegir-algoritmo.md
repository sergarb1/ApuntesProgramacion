...
> 🗺️ **Estás en:** 🧩 **U06 · Algorítmica I: Fundamentos** → 07 · Elegir el algoritmo adecuado
...
- Si **ordenas una vez y buscas muchas veces** → ordena con algo decente (en la U07 verás cómo) y luego usa binaria. La inversión se amortiza.
...
¿Y si tu tienda recibiera **miles de consultas al día** sobre el mismo catálogo? Entonces merece la pena ordenar el array una vez (cuesta O(n²) con lo que sabes hoy, pero en la U07 aprenderás más rápido) y usar búsqueda binaria en cada consulta. **Ordenar una vez, buscar mil.**
...
2. **¿Es grande y desordenado?** → No uses burbuja ni inserción. Espera a la U07 (QuickSort, MergeSort).
...
3. **Ni burbuja ni inserción**: con 60.000 elementos, O(n²) es un martirio. Toca esperar a la U07 (QuickSort/MergeSort, O(n log n)).
...
4. No usar burbuja ni inserción: su O(n²) sería un calvario. Espera a la U07 para ordenar como es debido.
...
3. Regla rápida: pequeño o desordenado → lineal; grande y ordenado → binaria; casi ordenado → inserción; grande y desordenado → espera a la U07.
...
📚 [Volver al índice de la unidad](/ApuntesProgramacion/06-algoritmica-fundamentos) · **Anterior:** [06 · Complejidad algorítmica: Big O](/ApuntesProgramacion/06-algoritmica-fundamentos/06-complejidad-big-o) · **Siguiente:** [08 · Be the Code: búsqueda binaria desde cero](/ApuntesProgramacion/06-algoritmica-fundamentos/08-be-the-code)
