---
title: "09 — Repaso interactivo: la caja que no cabía"
...
> 🗺️ **Estás en:** 🔤 **U02 · Variables, Tipos y Operadores** → 09 · Repaso interactivo
...
2. Java usa **coma flotante binaria**: `0.21` no se puede representar exactamente en binario, así que quedan residuos como `21.000000000000004`. Puedes dejarlo visualmente limpio redondeando con `Math.round(total * 100) / 100.0`, o simplemente aceptar que es un tema de precisión (los formatos de salida bonitos llegan en la U11).
...
No exactamente: `Math` es una **clase**, y `random()`, `pow()`, `round()`... son **métodos estáticos**. No creas ningún objeto de `Math`; llamas directamente `Math.random()`. Es la diferencia entre "llamar a la clase" y "llamar al objeto", que verás a fondo en la U07.
...
📚 [Volver al índice de la unidad](/ApuntesProgramacion/02-variables-tipos-operadores) · **Anterior:** [08 · Métodos útiles de String](/ApuntesProgramacion/02-variables-tipos-operadores/08-metodos-string) · **Siguiente:** **[U03 · Estructuras de Control](/ApuntesProgramacion/03-estructuras-control-excepciones)**