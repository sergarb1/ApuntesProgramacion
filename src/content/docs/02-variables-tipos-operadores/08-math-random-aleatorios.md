---
title: 08 — Math.random() y números aleatorios
...
> 🗺️ **Estás en:** 🔤 **U02 · Variables, Tipos y Operadores** → 08 · Math.random() y números aleatorios
...
📚 [Volver al índice de la unidad](/ApuntesProgramacion/02-variables-tipos-operadores) · **Anterior:** [07 · Consola: salida formateada y errores de entrada](/ApuntesProgramacion/02-variables-tipos-operadores/07-consola-salida-formateada) · **Siguiente:** [09 · Métodos útiles de String](/ApuntesProgramacion/02-variables-tipos-operadores/09-metodos-string)