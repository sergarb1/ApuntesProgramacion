...
> 🗺️ **Estás en:** 📁 **U123 · Ficheros y Expresiones Regulares** → 01 · La clase File: tu explorador de archivos
...
En la U12 guardabas tus datos en memoria: listas, mapas, objetos... todo vivo mientras el programa corre. Pero ¿y si quieres saber si un archivo existe antes de abrirlo? ¿Y si necesitas recorrer las carpetas de tu disco? Ahí entra la clase `File`. No lee ni escribe nada: solo explora y describe. Es el portero del edificio de los ficheros.
...
📁 [Volver al índice de la unidad](/ApuntesProgramacion/14-ficheros-regex) · **Anterior:** — · **Siguiente:** [02 · Escribir y leer texto: FileWriter, FileReader y BufferedReader](/ApuntesProgramacion/14-ficheros-regex/02-escribir-leer-texto)