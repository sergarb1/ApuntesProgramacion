...
> 🗺️ **Estás en:** 📁 **U123 · Ficheros y Expresiones Regulares** → 09 · Repaso interactivo
...
**PROXIMAMENTE EN U124:** Conexión a bases de datos con JDBC. El momento en que tus programas aprenden a hablar con un gestor de bases de datos relacional. 🗄️

---

📁 [Volver al índice de la unidad](/ApuntesProgramacion/14-ficheros-regex) · **Anterior:** [08 · Regex en acción: matches, replaceAll, split y validaciones](/ApuntesProgramacion/14-ficheros-regex/08-regex-aplicaciones) · **Siguiente:** **[U124 · Conexión a BD con JDBC](/ApuntesProgramacion/15-conexion-bases-datos)**