---
title: "Boletín 11 — Extras: Consola, Ficheros y Expresiones Regulares"
description: Ejercicios extra de la unidad 11 (CodeWars y AceptaElReto)
---
...
> **Pista:** Edad >= 55 y hándicap > 7 → "Senior", si no → "Open". Simple lógica booleana.
...
> **Pista:** Divide por 2, luego por impares hasta √n; cuenta las repeticiones de cada divisor.

**AceptaElReto:**

- [108 - Hormigas](https://www.aceptaelreto.com/problem/statement.php?id=108) (⭐⭐)
> **Pista:** Piensa en posiciones relativas: cuando dos hormigas se cruzan, es como si se ignoraran.
- [380 - ¡Qué grande es el cine!](https://www.aceptaelreto.com/problem/statement.php?id=380) (⭐⭐)
