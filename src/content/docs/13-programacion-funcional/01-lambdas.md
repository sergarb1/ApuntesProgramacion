...
> 🗺️ **Estás en:** 🎯 **U122 · Programación Funcional** → 01 · Lambdas: funciones que viajan solas
...
En la U11 viste las colecciones y en la U12 los genéricos y los mapas. Todo genial. Pero para recorrerlas siempre había una constante: los bucles y los métodos uno tras otro. Hoy cambia la jugada: las funciones dejan de estar encadenadas a una clase y empiezan a **viajar solas**.
...
📚 [Volver al índice de la unidad](/ApuntesProgramacion/13-programacion-funcional) · **Anterior:** — · **Siguiente:** [02 · Interfaces funcionales: Predicate, Function, Consumer, Supplier](/ApuntesProgramacion/13-programacion-funcional/02-interfaces-funcionales)