...
> 🗺️ **Estás en:** 🎯 **U122 · Programación Funcional** → 04 · Streams: el flujo de datos
...
Hasta ahora, para trabajar con una lista de la U11 escribías `for (String s : lista)` y dentro hacías la magia. El stream es otra filosofía: en vez de decirle a Java **cómo** recorrer (bucle, índice, iterador), le dices **qué** quieres conseguir y él monta la cinta. Tú diseñas el flujo; Java mueve los paquetes.
...
- `lista.stream()` — la fuente más común: cualquier colección de la U11 tiene este método.
- `Stream.of(a, b, c)` — cuando quieres un flujo a partir de varios valores sin montar una lista.
- `Arrays.stream(array)` — para convertir un array de la U05 en flujo.
...
📚 [Volver al índice de la unidad](/ApuntesProgramacion/13-programacion-funcional) · **Anterior:** [03 · Referencias a métodos: el atajo `::`](/ApuntesProgramacion/13-programacion-funcional/03-referencias-metodos) · **Siguiente:** [05 · Operaciones intermedias: filter, map, distinct, sorted, limit](/ApuntesProgramacion/13-programacion-funcional/05-streams-intermedias)