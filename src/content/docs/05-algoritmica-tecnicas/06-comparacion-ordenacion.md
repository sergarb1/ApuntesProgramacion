...
> 🗺️ **Estás en:** ⚡ **U05 · Algorítmica II: Técnicas** → 06 · Comparación: cuándo usar cada ordenación
...
Ya has visto Quicksort y Mergesort, y en la U04 sobreviviste a burbuja e inserción. Ahora toca la pregunta de examen, de entrevista y de la vida real: *¿cuál uso?* La respuesta siempre empieza igual: *depende*.
...
📚 [Volver al índice de la unidad](/ApuntesProgramacion/05-algoritmica-tecnicas) · **Anterior:** [05 · Mergesort](/ApuntesProgramacion/05-algoritmica-tecnicas/05-mergesort) · **Siguiente:** [07 · Be the Code: quicksort desde cero](/ApuntesProgramacion/05-algoritmica-tecnicas/07-be-the-code-quicksort)
