...
📁 [Volver al índice de la unidad](/ApuntesProgramacion/13-ficheros-regex) · **Anterior:** [04 · PrintWriter y Scanner + File](/ApuntesProgramacion/13-ficheros-regex/04-printwriter-scanner-file) · **Siguiente:** [06 · Serialización: guardar objetos con ObjectOutputStream](/ApuntesProgramacion/13-ficheros-regex/06-serializacion)