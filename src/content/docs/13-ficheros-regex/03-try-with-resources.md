...
📁 [Volver al índice de la unidad](/ApuntesProgramacion/13-ficheros-regex) · **Anterior:** [02 · Escribir y leer texto: FileWriter, FileReader y BufferedReader](/ApuntesProgramacion/13-ficheros-regex/02-escribir-leer-texto) · **Siguiente:** [04 · PrintWriter y Scanner + File](/ApuntesProgramacion/13-ficheros-regex/04-printwriter-scanner-file)