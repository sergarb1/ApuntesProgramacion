...
¿Una lista de objetos? También se serializa de una vez. Es la forma más cómoda de "persistir" tus datos de la U11:
...
📁 [Volver al índice de la unidad](/ApuntesProgramacion/13-ficheros-regex) · **Anterior:** [05 · NIO: Files y Paths (la forma moderna)](/ApuntesProgramacion/13-ficheros-regex/05-nio-files-paths) · **Siguiente:** [07 · Expresiones regulares: Pattern y Matcher](/ApuntesProgramacion/13-ficheros-regex/07-regex-basica)