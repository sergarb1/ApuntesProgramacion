...
📁 [Volver al índice de la unidad](/ApuntesProgramacion/13-ficheros-regex) · **Anterior:** [06 · Serialización: guardar objetos con ObjectOutputStream](/ApuntesProgramacion/13-ficheros-regex/06-serializacion) · **Siguiente:** [08 · Regex en acción: matches, replaceAll, split y validaciones](/ApuntesProgramacion/13-ficheros-regex/08-regex-aplicaciones)