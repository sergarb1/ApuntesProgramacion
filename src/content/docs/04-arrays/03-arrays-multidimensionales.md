...
> 🗺️ **Estás en:** 🅿️ **U04 · Arrays** → 03 · Arrays multidimensionales
...
📚 [Volver al índice de la unidad](/ApuntesProgramacion/04-arrays) · **Anterior:** [02 · Recorrer arrays: for y for-each](/ApuntesProgramacion/04-arrays/02-recorrer-arrays) · **Siguiente:** [04 · La clase Arrays: tu navaja suiza](/ApuntesProgramacion/04-arrays/04-clase-arrays)