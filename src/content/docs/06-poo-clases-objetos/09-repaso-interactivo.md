...
> 🗺️ **Estás en:** 🏗️ **U06 · POO: Clases y Objetos** → 09 · Repaso interactivo
...
Esa es la convención de los **getters y setters**: métodos para leer (`getSaldo`) y modificar (`setSaldo`) atributos de forma controlada. Suena a burocracia, pero es la base de la **encapsulación**, y tiene su unidad entera: la U07. Aquí los verás de refilón; allí los dominarás.
...
**PRÓXIMAMENTE EN U07:** Visibilidad, encapsulación y `static`. El momento en el que tus objetos aprenden a decir "eso no se toca". 🔒

---

📚 [Volver al índice de la unidad](/ApuntesProgramacion/06-poo-clases-objetos) · **Anterior:** [08 · Be the Code: diseña tu clase](/ApuntesProgramacion/06-poo-clases-objetos/08-be-the-code) · **Siguiente:** **[U07 · Visibilidad, Encapsulación y Static](/ApuntesProgramacion/07-visibilidad-encapsulacion-static)**