...
> 🗺️ **Estás en:** 🏗️ **U06 · POO: Clases y Objetos** → 02 · Clases y objetos: el cortapastas y las galletas
...
📚 [Volver al índice de la unidad](/ApuntesProgramacion/06-poo-clases-objetos) · **Anterior:** [01 · Qué es la POO](/ApuntesProgramacion/06-poo-clases-objetos/01-que-es-poo) · **Siguiente:** [03 · Atributos y métodos](/ApuntesProgramacion/06-poo-clases-objetos/03-atributos-metodos)