...
> 🗺️ **Estás en:** 🗄️ **U14 · Persistencia de datos: JDBC e introducción a ORM** → 04 · CRUD completo
...
Ya sabes conectar y consultar. Ahora toca la rutina de toda aplicación con base de datos: **insertar, leer, actualizar y borrar**. Es el pan de cada día. Aquí vamos a construir el ejemplo completo con una tabla `contactos`, un POJO (objeto Java, de los que conociste en la U08) y los cuatro métodos. Prepara la cafetera.
...
Cada fila de la tabla se convierte en un objeto Java. Es la clase de siempre, con atributos privados, getters y setters (la viste en la U08 y la U09):
...
Leer todos los contactos. La consulta devuelve filas y las convertimos en una `List<Contacto>` (colecciones, U11, haciendo de las suyas):
...
📚 [Volver al índice de la unidad](/ApuntesProgramacion/14-conexion-bases-datos) · **Anterior:** [03 · Statement y ResultSet](/ApuntesProgramacion/14-conexion-bases-datos/03-statement-resultset) · **Siguiente:** [05 · PreparedStatement y SQL injection](/ApuntesProgramacion/14-conexion-bases-datos/05-preparedstatement)