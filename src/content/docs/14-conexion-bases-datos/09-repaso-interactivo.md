...
**PROXIMAMENTE EN U15:** Servir y Consumir APIs con Web. El momento en que tu programa Java se pone un uniforme de camarero: recibe peticiones HTTP y sirve datos en JSON. 🌐

---

📚 [Volver al índice de la unidad](/ApuntesProgramacion/14-conexion-bases-datos) · **Anterior:** [08 · Buenas prácticas](/ApuntesProgramacion/14-conexion-bases-datos/08-buenas-practicas) · **Siguiente:** **[U15 · Servir y Consumir APIs con Web](/ApuntesProgramacion/15-apis-web)**