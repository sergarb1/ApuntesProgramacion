---
title: "Boletín 13 — Extras: Conexión a Bases de Datos con JDBC"
description: Ejercicios extra de la unidad 13 (CodeWars y AceptaElReto)
---
...
- [245 - ¿Quién gana la partida?](https://www.aceptaelreto.com/problem/statement.php?id=245) (⭐⭐⭐)
> **Pista:** Simula los turnos con una `Queue<Integer>`; cada ronda mueve al primero al final si no acierta.
- [424 - Billetes de autobús](https://www.aceptaelreto.com/problem/statement.php?id=424) (⭐⭐)
