...
> 🗺️ **Estás en:** 🧠 **U01 · Introducción al Pensamiento Computacional** → 01 · Qué es un ordenador y un lenguaje de programación
...
> Aprender la sintaxis de Java es fácil (es como aprender vocabulario). El reto real de este curso no es memorizar el diccionario, sino saber **qué demonios quieres decirle a la máquina** para resolver un problema. ¡Y de eso trata el resto de esta Unidad 1! 🚀

---

📚 [Volver al índice de la unidad](/ApuntesProgramacion/01-pensamiento-computacional) · **Anterior:** [Índice de la unidad](/ApuntesProgramacion/01-pensamiento-computacional) · **Siguiente:** [02 · Programar no es memorizar código](/ApuntesProgramacion/01-pensamiento-computacional/02-no-memorizar)
