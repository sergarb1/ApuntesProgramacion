...
> 🗺️ **Estás en:** 🧠 **U01 · Introducción al Pensamiento Computacional** → 09 · Mi primer problema (puente a Java)

---

Hemos llegado al final de esta Unidad 1! Después de desmontar falsos mitos, de pelearnos con la literalidad de los robots, de aprender a no tener miedo al texto rojo y de poner a la IA a trabajar como tutor privado, llega el momento de la verdad: **resolver nuestro primer problema de programación real.** 🥳🎉
...
| 🧠 TU LÓGICA (Unidad 1) | ☕ LA TRADUCCIÓN A JAVA (Unidad 2) |
| --- | --- |
...
## 💡 Idea clave para cerrar la Unidad 1

> **Ya sabes pensar como un programador/a.**

> Ahora que tienes el método, la mentalidad y el protocolo para no bloquearte, abrimos la puerta a la Unidad 2. ¡Bienvenido/a al mundo real de Java! 🚀☕💻
...
📚 [Volver al índice de la unidad](/ApuntesProgramacion/01-pensamiento-computacional) · **Anterior:** [08 · Cómo utilizaremos la IA](/ApuntesProgramacion/01-pensamiento-computacional/08-ia-tutor) · **Siguiente:** **[U02 · Introducción a Java y el entorno de trabajo](/ApuntesProgramacion/02-introduccion)**
