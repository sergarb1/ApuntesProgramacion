# ra-ce — Referencia de RAs y CEs del módulo Programación (0485)

> Fuente: BOE-A-2010-9269 (RD 686/2010) y BOE equivalente para DAM. Las tablas de "CEs cubiertos" de cada índice de unidad se construyen a partir de esta lista, seleccionando los CEs que el contenido de la unidad cubre de verdad.
...
## Mapa de unidades → RAs (usado en los índices)

| Unidad | RAs declarados | Contenido principal |
|---|---|---|
| U01 Introducción a Java | RA1 | JDK/JRE/JVM, instalación, Hola Mundo, depurador, comentarios, args |
| U02 Variables, Tipos y Operadores | RA2 (+RA1 d-h) | tipos primitivos, variables, operadores, conversiones, Scanner |
| U03 Estructuras de Control | RA3 | if/switch, bucles, break/continue, excepciones |
| U04 Algorítmica I: Fundamentos | RA2, RA6 | pseudocódigo, diagramas, funciones, divide y vencerás |
| U05 Algorítmica II: Técnicas | RA2, RA6 | ordenación, búsqueda, recursividad |
| U06 POO: Clases y Objetos | RA2, RA4 | clases, atributos, métodos, constructores |
| U07 Visibilidad, Encapsulación y Static | RA4 | public/private/protected, getters/setters, static, final |
| U08 Herencia, Polimorfismo e Interfaces | RA4, RA7 | herencia, super, sobrescritura, abstract, interfaces |
| U09 Arrays y Colecciones | RA6 | arrays, Arrays, ArrayList, LinkedList |
| U10 Genéricos y Mapas | RA6 | genéricos, Map, HashMap, TreeMap |
